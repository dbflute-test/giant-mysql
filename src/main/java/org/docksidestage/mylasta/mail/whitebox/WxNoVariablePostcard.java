 ...
 * @author FreeGen
 */
public class WxNoVariablePostcard extends LaTypicalPostcard implements org.docksidestage.mylasta.mail.PluggedinGiantPostcard {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    public static final String PATH = "whitebox/wx_no_variable.dfmail";

    // ===================================================================================
    //                                                                         Entry Point
    //                                                                         ===========
    public static WxNoVariablePostcard droppedInto(Postbox postbox, MPCall<WxNoVariablePostcard> postcardLambda) {
        WxNoVariablePostcard postcard = new WxNoVariablePostcard();
