 ...
 * @author FreeGen
 */
public class WxRemoteApiPostcard extends LaTypicalPostcard implements org.docksidestage.mylasta.mail.PluggedinGiantPostcard {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    public static final String PATH = "whitebox/wx_remote_api.dfmail";

    // ===================================================================================
    //                                                                         Entry Point
    //                                                                         ===========
    public static WxRemoteApiPostcard droppedInto(Postbox postbox, MPCall<WxRemoteApiPostcard> postcardLambda) {
        WxRemoteApiPostcard postcard = new WxRemoteApiPostcard();
