 ...
 */
package org.docksidestage.mylasta.mail;
 ...
 * @author FreeGen
 */
public class RootestWelcomeMemberPostcard extends LaTypicalPostcard implements org.docksidestage.mylasta.mail.PluggedinGiantPostcard {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    public static final String PATH = "rootest_welcome_member.dfmail";

    // ===================================================================================
    //                                                                         Entry Point
    //                                                                         ===========
    public static RootestWelcomeMemberPostcard droppedInto(Postbox postbox, MPCall<RootestWelcomeMemberPostcard> postcardLambda) {
        RootestWelcomeMemberPostcard postcard = new RootestWelcomeMemberPostcard();
    ...
    protected String[] getPropertyNames() {
        return new String[] {"memberName", "birthdate"};
    }
    ...
    /**
     * Set the value of birthdate, used in parameter comment. <br>
     * Even if empty string, treated as empty plainly. So "IF pmb != null" is false if empty.
     * @param birthdate The parameter value of birthdate. (NotNull)
     */
    public void setBirthdate(String birthdate) {
        registerVariable("birthdate", birthdate);
    }
}
