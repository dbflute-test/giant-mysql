...
public interface GiantEnv {
    ...
    /** The key of the configuration. e.g. /tmp/lastaflute/giant */
    ...
    /** The key of the configuration. e.g. giant-support@annie.example.com */
    String MAIL_ADDRESS_SUPPORT = "mail.address.support";

    /** The key of the configuration. e.g. com.mysql.cj.jdbc.Driver */
    String JDBC_DRIVER = "jdbc.driver";

    /** The key of the configuration. e.g. jdbc:mysql://localhost:53376/maihamadb?allowPublicKeyRetrieval=true&amp;useSSL=false */
    ...
    /** The key of the configuration. e.g. jdbc:mysql://localhost:53376/resortlinedb?allowPublicKeyRetrieval=true&amp;useSSL=false */
    ...
    /** The key of the configuration. e.g. /tmp/lastaflute/giant/tomcat */
     ...
     * The value is, e.g. /tmp/lastaflute/giant <br>
     ...
     * The value is, e.g. giant-support@annie.example.com <br>
     * comment: Mail Address for Giant Support
     * @return The value of found property. (NotNull: if not found, exception but basically no way)
     */
     ...
     * The value is, e.g. jdbc:mysql://localhost:53376/maihamadb?allowPublicKeyRetrieval=true&amp;useSSL=false <br>
     ...
     * The value is, e.g. jdbc:mysql://localhost:53376/resortlinedb?allowPublicKeyRetrieval=true&amp;useSSL=false <br>
     * comment: The URL of database connection for JDBC
     * @return The value of found property. (NotNull: if not found, exception but basically no way)
     */
     ...
     * The value is, e.g. /tmp/lastaflute/giant/tomcat <br>
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends ObjectiveConfig implements GiantEnv {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getLastaDiSmartDeployMode() {
            return get(GiantEnv.lasta_di_SMART_DEPLOY_MODE);
        }

        public String getDevelopmentHere() {
            return get(GiantEnv.DEVELOPMENT_HERE);
        }

        public boolean isDevelopmentHere() {
            return is(GiantEnv.DEVELOPMENT_HERE);
        }

        public String getEnvironmentTitle() {
            return get(GiantEnv.ENVIRONMENT_TITLE);
        }

        public String getFrameworkDebug() {
            return get(GiantEnv.FRAMEWORK_DEBUG);
        }

        public boolean isFrameworkDebug() {
            return is(GiantEnv.FRAMEWORK_DEBUG);
        }

        public String getTimeAdjustTimeMillis() {
            return get(GiantEnv.TIME_ADJUST_TIME_MILLIS);
        }

        public Long getTimeAdjustTimeMillisAsLong() {
            return getAsLong(GiantEnv.TIME_ADJUST_TIME_MILLIS);
        }

        public String getLogLevel() {
            return get(GiantEnv.LOG_LEVEL);
        }

        public String getLogConsoleLevel() {
            return get(GiantEnv.LOG_CONSOLE_LEVEL);
        }

        public String getLogFileBasedir() {
            return get(GiantEnv.LOG_FILE_BASEDIR);
        }

        public String getMailSendMock() {
            return get(GiantEnv.MAIL_SEND_MOCK);
        }

        public boolean isMailSendMock() {
            return is(GiantEnv.MAIL_SEND_MOCK);
        }

        public String getMailSmtpServerMainHostAndPort() {
            return get(GiantEnv.MAIL_SMTP_SERVER_MAIN_HOST_AND_PORT);
        }

        public String getMailSubjectTestPrefix() {
            return get(GiantEnv.MAIL_SUBJECT_TEST_PREFIX);
        }

        public String getMailReturnPath() {
            return get(GiantEnv.MAIL_RETURN_PATH);
        }

        public String getMailAddressSupport() {
            return get(GiantEnv.MAIL_ADDRESS_SUPPORT);
        }

        public String getJdbcDriver() {
            return get(GiantEnv.JDBC_DRIVER);
        }

        public String getJdbcUrl() {
            return get(GiantEnv.JDBC_URL);
        }

        public String getJdbcUser() {
            return get(GiantEnv.JDBC_USER);
        }

        public String getJdbcPassword() {
            return get(GiantEnv.JDBC_PASSWORD);
        }

        public String getJdbcConnectionPoolingSize() {
            return get(GiantEnv.JDBC_CONNECTION_POOLING_SIZE);
        }

        public Integer getJdbcConnectionPoolingSizeAsInteger() {
            return getAsInteger(GiantEnv.JDBC_CONNECTION_POOLING_SIZE);
        }

        public String getResolaJdbcDriver() {
            return get(GiantEnv.RESOLA_JDBC_DRIVER);
        }

        public String getResolaJdbcUrl() {
            return get(GiantEnv.RESOLA_JDBC_URL);
        }

        public String getResolaJdbcUser() {
            return get(GiantEnv.RESOLA_JDBC_USER);
        }

        public String getResolaJdbcPassword() {
            return get(GiantEnv.RESOLA_JDBC_PASSWORD);
        }

        public String getResolaJdbcConnectionPoolingSize() {
            return get(GiantEnv.RESOLA_JDBC_CONNECTION_POOLING_SIZE);
        }

        public Integer getResolaJdbcConnectionPoolingSizeAsInteger() {
            return getAsInteger(GiantEnv.RESOLA_JDBC_CONNECTION_POOLING_SIZE);
        }

        public String getServerDomain() {
            return get(GiantEnv.SERVER_DOMAIN);
        }

        public String getSwaggerEnabled() {
            return get(GiantEnv.SWAGGER_ENABLED);
        }

        public boolean isSwaggerEnabled() {
            return is(GiantEnv.SWAGGER_ENABLED);
        }

        public String getTomcatURIEncoding() {
            return get(GiantEnv.TOMCAT_URIEncoding);
        }

        public String getTomcatUseBodyEncodingForURI() {
            return get(GiantEnv.TOMCAT_USE_BODY_ENCODING_FOR_U_R_I);
        }

        public boolean isTomcatUseBodyEncodingForURI() {
            return is(GiantEnv.TOMCAT_USE_BODY_ENCODING_FOR_U_R_I);
        }

        public String getTomcatLogHome() {
            return get(GiantEnv.TOMCAT_LOG_HOME);
        }

        public String getTomcatAccesslogEnabled() {
            return get(GiantEnv.TOMCAT_ACCESSLOG_ENABLED);
        }

        public boolean isTomcatAccesslogEnabled() {
            return is(GiantEnv.TOMCAT_ACCESSLOG_ENABLED);
        }

        public String getTomcatAccesslogLogDir() {
            return get(GiantEnv.TOMCAT_ACCESSLOG_LOG_DIR);
        }
    }
}
