...
import org.docksidestage.mylasta.direction.sponsor.GiantApiFailureHook.UnifiedFailureResult.FailureErrorPart;
 ...
 * @author jflute
 */
public class GiantApiFailureHook implements ApiFailureHook { // #change_it for handling API failure
