 ...
 * @author jflute
 */
public class GiantSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public GiantSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
