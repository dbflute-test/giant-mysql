...
import org.docksidestage.mylasta.direction.sponsor.planner.memorable.MemorableRestlikeRouter;
import org.docksidestage.mylasta.direction.sponsor.planner.memorable.MemorableSmartphoneMapper;
 ...
 * @author jflute
 */
public class GiantActionAdjustmentProvider implements ActionAdjustmentProvider {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public GiantActionAdjustmentProvider(GiantConfig config) {
        this.config = config;
    ...
    protected ActionOptionAgent newActionOptionAgent(GiantConfig config) {
