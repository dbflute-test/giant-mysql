 ...
 * @author jflute
 */
public class GiantCurtainBeforeHook implements CurtainBeforeHook {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    private static final Logger logger = LoggerFactory.getLogger(GiantCurtainBeforeHook.class);

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final GiantConfig config;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public GiantCurtainBeforeHook(GiantConfig config) {
        this.config = config;
    }
    ...
    protected DfFinalTimeZoneProvider createFinalTimeZoneProvider() {
        return new DfFinalTimeZoneProvider() {
            protected final TimeZone provided = GiantUserTimeZoneProcessProvider.centralTimeZone;
    ...
    protected void whiteboxtest_findLoginManager() {
        OptionalThing<LoginManager> thing = ContainerUtil.getComponent(RequestManager.class).findLoginManager(GiantUserBean.class);
