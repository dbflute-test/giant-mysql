 ...
 * @author jflute
 */
public class GiantTimeResourceProvider extends TypicalTimeResourceProvider {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final GiantConfig maihamaConfig;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public GiantTimeResourceProvider(GiantConfig maihamaConfig) {
    ...
    protected TimeZone getCentralTimeZone() {
        return GiantUserTimeZoneProcessProvider.centralTimeZone;
    }
