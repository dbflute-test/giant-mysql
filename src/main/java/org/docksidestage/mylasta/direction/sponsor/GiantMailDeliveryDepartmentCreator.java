 ...
 * @author jflute
 */
public class GiantMailDeliveryDepartmentCreator {

    private static final Logger logger = LoggerFactory.getLogger(GiantMailDeliveryDepartmentCreator.class);
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public GiantMailDeliveryDepartmentCreator(GiantConfig config) {
        this.config = config;
    }
