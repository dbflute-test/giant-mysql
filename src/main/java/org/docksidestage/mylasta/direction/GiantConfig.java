 ...
 * @author FreeGen
 */
public interface GiantConfig extends GiantEnv, org.docksidestage.mylasta.direction.MyGiantProp {

    /** The key of the configuration. e.g. giant */
    ...
    String COOKIE_REMEMBER_ME_GIANT_KEY = "cookie.remember.me.giant.key";
    ...
    /**
     * Get the value for the key 'cookie.remember.me.giant.key'. <br>
     * The value is, e.g. FTR <br>
     * comment: The cookie key of auto-login for Giant
     * @return The value of found property. (NotNull: if not found, exception but basically no way)
     */
    String getCookieRememberMeGiantKey();
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends GiantEnv.SimpleImpl implements GiantConfig {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getDomainName() {
            return get(GiantConfig.DOMAIN_NAME);
        }

        public String getDomainTitle() {
            return get(GiantConfig.DOMAIN_TITLE);
        }

        public String getAppStandardDatePattern() {
            return get(GiantConfig.APP_STANDARD_DATE_PATTERN);
        }

        public String getAppStandardDatetimePattern() {
            return get(GiantConfig.APP_STANDARD_DATETIME_PATTERN);
        }

        public String getAppStandardTimePattern() {
            return get(GiantConfig.APP_STANDARD_TIME_PATTERN);
        }

        public String getCookieDefaultPath() {
            return get(GiantConfig.COOKIE_DEFAULT_PATH);
        }

        public String getCookieDefaultExpire() {
            return get(GiantConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public Integer getCookieDefaultExpireAsInteger() {
            return getAsInteger(GiantConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public String getCookieEternalExpire() {
            return get(GiantConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public Integer getCookieEternalExpireAsInteger() {
            return getAsInteger(GiantConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public String getCookieRememberMeGiantKey() {
            return get(GiantConfig.COOKIE_REMEMBER_ME_GIANT_KEY);
        }

        public String getPagingPageSize() {
            return get(GiantConfig.PAGING_PAGE_SIZE);
        }

        public Integer getPagingPageSizeAsInteger() {
            return getAsInteger(GiantConfig.PAGING_PAGE_SIZE);
        }

        public String getPagingPageRangeSize() {
            return get(GiantConfig.PAGING_PAGE_RANGE_SIZE);
        }

        public Integer getPagingPageRangeSizeAsInteger() {
            return getAsInteger(GiantConfig.PAGING_PAGE_RANGE_SIZE);
        }

        public String getPagingPageRangeFillLimit() {
            return get(GiantConfig.PAGING_PAGE_RANGE_FILL_LIMIT);
        }

        public boolean isPagingPageRangeFillLimit() {
            return is(GiantConfig.PAGING_PAGE_RANGE_FILL_LIMIT);
        }

        public String getWhiteboxConfigJapaneseCaos() {
            return get(GiantConfig.WHITEBOX_CONFIG_JAPANESE_CAOS);
        }

        public String getWhiteboxConfigEscapedLinesep() {
            return get(GiantConfig.WHITEBOX_CONFIG_ESCAPED_LINESEP);
        }
    }
}
