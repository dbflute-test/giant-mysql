...
import org.docksidestage.dbflute.cbean.cq.GiantSideCQ;

/**
 * The nest select set-upper of giant_side.
 * @author DBFlute(AutoGenerator)
 */
public class GiantSideNss {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final GiantSideCQ _query;
    public GiantSideNss(GiantSideCQ query) { _query = query; }
     ...
     * @return The set-upper of more nested relation. {...with[nested-relation].with[more-nested-relation]} (NotNull)
     */
    public GiantSideNss withGiantSideSelf() {
        _query.xdoNss(() -> _query.queryGiantSideSelf());
        return new GiantSideNss(_query.queryGiantSideSelf());
    }
    /**
     * With nested relation columns to select clause. <br>
