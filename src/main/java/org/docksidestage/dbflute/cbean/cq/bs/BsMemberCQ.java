...
public class BsMemberCQ extends AbstractBsMemberCQ {
    ...
    public Map<String, GiantCQ> xdfgetMemberId_ExistsReferrer_GiantList() { return xgetSQueMap("memberId_ExistsReferrer_GiantList"); }
    public String keepMemberId_ExistsReferrer_GiantList(GiantCQ sq) { return xkeepSQue("memberId_ExistsReferrer_GiantList", sq); }

    public Map<String, GiantRefCQ> xdfgetMemberId_ExistsReferrer_GiantRefList() { return xgetSQueMap("memberId_ExistsReferrer_GiantRefList"); }
    public String keepMemberId_ExistsReferrer_GiantRefList(GiantRefCQ sq) { return xkeepSQue("memberId_ExistsReferrer_GiantRefList", sq); }

    public Map<String, GiantSideCQ> xdfgetMemberId_ExistsReferrer_GiantSideList() { return xgetSQueMap("memberId_ExistsReferrer_GiantSideList"); }
    public String keepMemberId_ExistsReferrer_GiantSideList(GiantSideCQ sq) { return xkeepSQue("memberId_ExistsReferrer_GiantSideList", sq); }
    ...
    public Map<String, GiantCQ> xdfgetMemberId_NotExistsReferrer_GiantList() { return xgetSQueMap("memberId_NotExistsReferrer_GiantList"); }
    public String keepMemberId_NotExistsReferrer_GiantList(GiantCQ sq) { return xkeepSQue("memberId_NotExistsReferrer_GiantList", sq); }

    public Map<String, GiantRefCQ> xdfgetMemberId_NotExistsReferrer_GiantRefList() { return xgetSQueMap("memberId_NotExistsReferrer_GiantRefList"); }
    public String keepMemberId_NotExistsReferrer_GiantRefList(GiantRefCQ sq) { return xkeepSQue("memberId_NotExistsReferrer_GiantRefList", sq); }

    public Map<String, GiantSideCQ> xdfgetMemberId_NotExistsReferrer_GiantSideList() { return xgetSQueMap("memberId_NotExistsReferrer_GiantSideList"); }
    public String keepMemberId_NotExistsReferrer_GiantSideList(GiantSideCQ sq) { return xkeepSQue("memberId_NotExistsReferrer_GiantSideList", sq); }
    ...
    public Map<String, GiantCQ> xdfgetMemberId_SpecifyDerivedReferrer_GiantList() { return xgetSQueMap("memberId_SpecifyDerivedReferrer_GiantList"); }
    public String keepMemberId_SpecifyDerivedReferrer_GiantList(GiantCQ sq) { return xkeepSQue("memberId_SpecifyDerivedReferrer_GiantList", sq); }

    public Map<String, GiantRefCQ> xdfgetMemberId_SpecifyDerivedReferrer_GiantRefList() { return xgetSQueMap("memberId_SpecifyDerivedReferrer_GiantRefList"); }
    public String keepMemberId_SpecifyDerivedReferrer_GiantRefList(GiantRefCQ sq) { return xkeepSQue("memberId_SpecifyDerivedReferrer_GiantRefList", sq); }

    public Map<String, GiantSideCQ> xdfgetMemberId_SpecifyDerivedReferrer_GiantSideList() { return xgetSQueMap("memberId_SpecifyDerivedReferrer_GiantSideList"); }
    public String keepMemberId_SpecifyDerivedReferrer_GiantSideList(GiantSideCQ sq) { return xkeepSQue("memberId_SpecifyDerivedReferrer_GiantSideList", sq); }
    ...
    public Map<String, GiantCQ> xdfgetMemberId_QueryDerivedReferrer_GiantList() { return xgetSQueMap("memberId_QueryDerivedReferrer_GiantList"); }
    public String keepMemberId_QueryDerivedReferrer_GiantList(GiantCQ sq) { return xkeepSQue("memberId_QueryDerivedReferrer_GiantList", sq); }
    public Map<String, Object> xdfgetMemberId_QueryDerivedReferrer_GiantListParameter() { return xgetSQuePmMap("memberId_QueryDerivedReferrer_GiantList"); }
    public String keepMemberId_QueryDerivedReferrer_GiantListParameter(Object pm) { return xkeepSQuePm("memberId_QueryDerivedReferrer_GiantList", pm); }

    public Map<String, GiantRefCQ> xdfgetMemberId_QueryDerivedReferrer_GiantRefList() { return xgetSQueMap("memberId_QueryDerivedReferrer_GiantRefList"); }
    public String keepMemberId_QueryDerivedReferrer_GiantRefList(GiantRefCQ sq) { return xkeepSQue("memberId_QueryDerivedReferrer_GiantRefList", sq); }
    public Map<String, Object> xdfgetMemberId_QueryDerivedReferrer_GiantRefListParameter() { return xgetSQuePmMap("memberId_QueryDerivedReferrer_GiantRefList"); }
    public String keepMemberId_QueryDerivedReferrer_GiantRefListParameter(Object pm) { return xkeepSQuePm("memberId_QueryDerivedReferrer_GiantRefList", pm); }

    public Map<String, GiantSideCQ> xdfgetMemberId_QueryDerivedReferrer_GiantSideList() { return xgetSQueMap("memberId_QueryDerivedReferrer_GiantSideList"); }
    public String keepMemberId_QueryDerivedReferrer_GiantSideList(GiantSideCQ sq) { return xkeepSQue("memberId_QueryDerivedReferrer_GiantSideList", sq); }
    public Map<String, Object> xdfgetMemberId_QueryDerivedReferrer_GiantSideListParameter() { return xgetSQuePmMap("memberId_QueryDerivedReferrer_GiantSideList"); }
    public String keepMemberId_QueryDerivedReferrer_GiantSideListParameter(Object pm) { return xkeepSQuePm("memberId_QueryDerivedReferrer_GiantSideList", pm); }
