...
/**
 * The abstract condition-query of giant_side.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsGiantSideCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsGiantSideCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param giantSideId The value of giantSideId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setGiantSideId_Equal(Long giantSideId) {
        doSetGiantSideId_Equal(giantSideId);
    }

    protected void doSetGiantSideId_Equal(Long giantSideId) {
        regGiantSideId(CK_EQ, giantSideId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * GIANT_SIDE_ID: {PK, NotNull, BIGINT(19)}
     * @param giantSideId The value of giantSideId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setGiantSideId_NotEqual(Long giantSideId) {
        doSetGiantSideId_NotEqual(giantSideId);
    }

    protected void doSetGiantSideId_NotEqual(Long giantSideId) {
        regGiantSideId(CK_NES, giantSideId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * GIANT_SIDE_ID: {PK, NotNull, BIGINT(19)}
     * @param giantSideId The value of giantSideId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setGiantSideId_GreaterThan(Long giantSideId) {
        regGiantSideId(CK_GT, giantSideId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * GIANT_SIDE_ID: {PK, NotNull, BIGINT(19)}
     * @param giantSideId The value of giantSideId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setGiantSideId_LessThan(Long giantSideId) {
        regGiantSideId(CK_LT, giantSideId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * GIANT_SIDE_ID: {PK, NotNull, BIGINT(19)}
     * @param giantSideId The value of giantSideId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setGiantSideId_GreaterEqual(Long giantSideId) {
        regGiantSideId(CK_GE, giantSideId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * GIANT_SIDE_ID: {PK, NotNull, BIGINT(19)}
     * @param giantSideId The value of giantSideId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setGiantSideId_LessEqual(Long giantSideId) {
        regGiantSideId(CK_LE, giantSideId);
    }
     ...
     * GIANT_SIDE_ID: {PK, NotNull, BIGINT(19)}
     * @param minNumber The min number of giantSideId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of giantSideId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setGiantSideId_RangeOf(Long minNumber, Long maxNumber, ConditionOptionCall<RangeOfOption> opLambda) {
        setGiantSideId_RangeOf(minNumber, maxNumber, xcROOP(opLambda));
    }
     ...
     */
    protected void setGiantSideId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueGiantSideId(), "GIANT_SIDE_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * GIANT_SIDE_ID: {PK, NotNull, BIGINT(19)}
     * @param giantSideIdList The collection of giantSideId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setGiantSideId_InScope(Collection<Long> giantSideIdList) {
        doSetGiantSideId_InScope(giantSideIdList);
    }

    protected void doSetGiantSideId_InScope(Collection<Long> giantSideIdList) {
        regINS(CK_INS, cTL(giantSideIdList), xgetCValueGiantSideId(), "GIANT_SIDE_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * GIANT_SIDE_ID: {PK, NotNull, BIGINT(19)}
     * @param giantSideIdList The collection of giantSideId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setGiantSideId_NotInScope(Collection<Long> giantSideIdList) {
        doSetGiantSideId_NotInScope(giantSideIdList);
    }

    protected void doSetGiantSideId_NotInScope(Collection<Long> giantSideIdList) {
        regINS(CK_NINS, cTL(giantSideIdList), xgetCValueGiantSideId(), "GIANT_SIDE_ID");
    }

    /**
     * Set up ExistsReferrer (correlated sub-query). <br>
     * {exists (select SELF_PARENT_ID from giant_side where ...)} <br>
     * (simple Side of Giant)giant_side by SELF_PARENT_ID, named 'giantSideSelfAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">existsGiantSideSelf</span>(sideCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     sideCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of GiantSideSelfList for 'exists'. (NotNull)
     */
    public void existsGiantSideSelf(SubQuery<GiantSideCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        GiantSideCB cb = new GiantSideCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepGiantSideId_ExistsReferrer_GiantSideSelfList(cb.query());
        registerExistsReferrer(cb.query(), "GIANT_SIDE_ID", "SELF_PARENT_ID", pp, "giantSideSelfList");
    }
    public abstract String keepGiantSideId_ExistsReferrer_GiantSideSelfList(GiantSideCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select SELF_PARENT_ID from giant_side where ...)} <br>
     * (simple Side of Giant)giant_side by SELF_PARENT_ID, named 'giantSideSelfAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">notExistsGiantSideSelf</span>(sideCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     sideCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of GiantSideId_NotExistsReferrer_GiantSideSelfList for 'not exists'. (NotNull)
     */
    public void notExistsGiantSideSelf(SubQuery<GiantSideCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        GiantSideCB cb = new GiantSideCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepGiantSideId_NotExistsReferrer_GiantSideSelfList(cb.query());
        registerNotExistsReferrer(cb.query(), "GIANT_SIDE_ID", "SELF_PARENT_ID", pp, "giantSideSelfList");
    }
    public abstract String keepGiantSideId_NotExistsReferrer_GiantSideSelfList(GiantSideCQ sq);

    public void xsderiveGiantSideSelfList(String fn, SubQuery<GiantSideCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        GiantSideCB cb = new GiantSideCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepGiantSideId_SpecifyDerivedReferrer_GiantSideSelfList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "GIANT_SIDE_ID", "SELF_PARENT_ID", pp, "giantSideSelfList", al, op);
    }
    public abstract String keepGiantSideId_SpecifyDerivedReferrer_GiantSideSelfList(GiantSideCQ sq);
     ...
     * (simple Side of Giant)giant_side by SELF_PARENT_ID, named 'giantSideSelfAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">derivedGiantSideSelf()</span>.<span style="color: #CC4747">max</span>(sideCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public HpQDRFunction<GiantSideCB> derivedGiantSideSelf() {
        return xcreateQDRFunctionGiantSideSelfList();
    }
    protected HpQDRFunction<GiantSideCB> xcreateQDRFunctionGiantSideSelfList() {
        return xcQDRFunc((fn, sq, rd, vl, op) -> xqderiveGiantSideSelfList(fn, sq, rd, vl, op));
    }
    public void xqderiveGiantSideSelfList(String fn, SubQuery<GiantSideCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        GiantSideCB cb = new GiantSideCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepGiantSideId_QueryDerivedReferrer_GiantSideSelfList(cb.query()); String prpp = keepGiantSideId_QueryDerivedReferrer_GiantSideSelfListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "GIANT_SIDE_ID", "SELF_PARENT_ID", sqpp, "giantSideSelfList", rd, vl, prpp, op);
    }
    public abstract String keepGiantSideId_QueryDerivedReferrer_GiantSideSelfList(GiantSideCQ sq);
    public abstract String keepGiantSideId_QueryDerivedReferrer_GiantSideSelfListParameter(Object vl);

    /**
     * IsNull {is null}. And OnlyOnceRegistered. <br>
     * GIANT_SIDE_ID: {PK, NotNull, BIGINT(19)}
     */
    public void setGiantSideId_IsNull() { regGiantSideId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * GIANT_SIDE_ID: {PK, NotNull, BIGINT(19)}
     */
    public void setGiantSideId_IsNotNull() { regGiantSideId(CK_ISNN, DOBJ); }

    protected void regGiantSideId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueGiantSideId(), "GIANT_SIDE_ID"); }
    protected abstract ConditionValue xgetCValueGiantSideId();
     ...
     */
    public HpSLCFunction<GiantSideCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, GiantSideCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<GiantSideCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, GiantSideCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<GiantSideCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, GiantSideCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<GiantSideCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, GiantSideCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<GiantSideCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, GiantSideCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;GiantSideCB&gt;() {
     *     public void query(GiantSideCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<GiantSideCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, GiantSideCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        GiantSideCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(GiantSideCQ sq);

    protected GiantSideCB xcreateScalarConditionCB() {
        GiantSideCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected GiantSideCB xcreateScalarConditionPartitionByCB() {
        GiantSideCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<GiantSideCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        GiantSideCB cb = new GiantSideCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "GIANT_SIDE_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(GiantSideCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<GiantSideCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(GiantSideCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        GiantSideCB cb = new GiantSideCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "GIANT_SIDE_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(GiantSideCQ sq);
     ...
     */
    public void myselfExists(SubQuery<GiantSideCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        GiantSideCB cb = new GiantSideCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(GiantSideCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected GiantSideCB newMyCB() {
        return new GiantSideCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return GiantSideCQ.class.getName(); }
