...
/**
 * The abstract condition-query of giant.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsGiantCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsGiantCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * {exists (select SELF_PARENT_ID from giant where ...)} <br>
     * (Giant as base point)giant by SELF_PARENT_ID, named 'giantSelfAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">existsGiantSelf</span>(giantCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     giantCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of GiantSelfList for 'exists'. (NotNull)
     */
    public void existsGiantSelf(SubQuery<GiantCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        GiantCB cb = new GiantCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepGiantId_ExistsReferrer_GiantSelfList(cb.query());
        registerExistsReferrer(cb.query(), "GIANT_ID", "SELF_PARENT_ID", pp, "giantSelfList");
    }
    public abstract String keepGiantId_ExistsReferrer_GiantSelfList(GiantCQ sq);

    /**
     * Set up ExistsReferrer (correlated sub-query). <br>
     * {exists (select GIANT_ID from giant_ref where ...)} <br>
     * (Referrer of Giant)giant_ref by GIANT_ID, named 'giantRefAsOne'.
     * <pre>
    ...
    public void existsGiantRef(SubQuery<GiantRefCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepGiantId_ExistsReferrer_GiantRefList(cb.query());
        registerExistsReferrer(cb.query(), "GIANT_ID", "GIANT_ID", pp, "giantRefList");
    }
    public abstract String keepGiantId_ExistsReferrer_GiantRefList(GiantRefCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select SELF_PARENT_ID from giant where ...)} <br>
     * (Giant as base point)giant by SELF_PARENT_ID, named 'giantSelfAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">notExistsGiantSelf</span>(giantCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     giantCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of GiantId_NotExistsReferrer_GiantSelfList for 'not exists'. (NotNull)
     */
    public void notExistsGiantSelf(SubQuery<GiantCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        GiantCB cb = new GiantCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepGiantId_NotExistsReferrer_GiantSelfList(cb.query());
        registerNotExistsReferrer(cb.query(), "GIANT_ID", "SELF_PARENT_ID", pp, "giantSelfList");
    }
    public abstract String keepGiantId_NotExistsReferrer_GiantSelfList(GiantCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select GIANT_ID from giant_ref where ...)} <br>
     * (Referrer of Giant)giant_ref by GIANT_ID, named 'giantRefAsOne'.
     * <pre>
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of GiantId_NotExistsReferrer_GiantRefList for 'not exists'. (NotNull)
     */
    public void notExistsGiantRef(SubQuery<GiantRefCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        GiantRefCB cb = new GiantRefCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepGiantId_NotExistsReferrer_GiantRefList(cb.query());
        registerNotExistsReferrer(cb.query(), "GIANT_ID", "GIANT_ID", pp, "giantRefList");
    }
    public abstract String keepGiantId_NotExistsReferrer_GiantRefList(GiantRefCQ sq);

    public void xsderiveGiantSelfList(String fn, SubQuery<GiantCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        GiantCB cb = new GiantCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepGiantId_SpecifyDerivedReferrer_GiantSelfList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "GIANT_ID", "SELF_PARENT_ID", pp, "giantSelfList", al, op);
    }
    public abstract String keepGiantId_SpecifyDerivedReferrer_GiantSelfList(GiantCQ sq);
    ...
    public void xsderiveGiantRefList(String fn, SubQuery<GiantRefCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepGiantId_SpecifyDerivedReferrer_GiantRefList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "GIANT_ID", "GIANT_ID", pp, "giantRefList", al, op);
    }
    public abstract String keepGiantId_SpecifyDerivedReferrer_GiantRefList(GiantRefCQ sq);
     ...
     * (Giant as base point)giant by SELF_PARENT_ID, named 'giantSelfAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">derivedGiantSelf()</span>.<span style="color: #CC4747">max</span>(giantCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public HpQDRFunction<GiantCB> derivedGiantSelf() {
        return xcreateQDRFunctionGiantSelfList();
    }
    protected HpQDRFunction<GiantCB> xcreateQDRFunctionGiantSelfList() {
        return xcQDRFunc((fn, sq, rd, vl, op) -> xqderiveGiantSelfList(fn, sq, rd, vl, op));
    }
    public void xqderiveGiantSelfList(String fn, SubQuery<GiantCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        GiantCB cb = new GiantCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepGiantId_QueryDerivedReferrer_GiantSelfList(cb.query()); String prpp = keepGiantId_QueryDerivedReferrer_GiantSelfListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "GIANT_ID", "SELF_PARENT_ID", sqpp, "giantSelfList", rd, vl, prpp, op);
    }
    public abstract String keepGiantId_QueryDerivedReferrer_GiantSelfList(GiantCQ sq);
    public abstract String keepGiantId_QueryDerivedReferrer_GiantSelfListParameter(Object vl);
    ...
    public void xqderiveGiantRefList(String fn, SubQuery<GiantRefCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        GiantRefCB cb = new GiantRefCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepGiantId_QueryDerivedReferrer_GiantRefList(cb.query()); String prpp = keepGiantId_QueryDerivedReferrer_GiantRefListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "GIANT_ID", "GIANT_ID", sqpp, "giantRefList", rd, vl, prpp, op);
    }
    public abstract String keepGiantId_QueryDerivedReferrer_GiantRefList(GiantRefCQ sq);
    public abstract String keepGiantId_QueryDerivedReferrer_GiantRefListParameter(Object vl);

    /**
     * IsNull {is null}. And OnlyOnceRegistered. <br>
     * GIANT_ID: {PK, NotNull, BIGINT(19)}
     */
    public void setGiantId_IsNull() { regGiantId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * GIANT_ID: {PK, NotNull, BIGINT(19)}
     */
    public void setGiantId_IsNotNull() { regGiantId(CK_ISNN, DOBJ); }
     ...
     */
    public HpSLCFunction<GiantCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, GiantCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<GiantCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, GiantCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<GiantCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, GiantCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<GiantCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, GiantCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<GiantCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, GiantCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;GiantCB&gt;() {
     *     public void query(GiantCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<GiantCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, GiantCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        GiantCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(GiantCQ sq);

    protected GiantCB xcreateScalarConditionCB() {
        GiantCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected GiantCB xcreateScalarConditionPartitionByCB() {
        GiantCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<GiantCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        GiantCB cb = new GiantCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "GIANT_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(GiantCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<GiantCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(GiantCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        GiantCB cb = new GiantCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "GIANT_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(GiantCQ sq);
     ...
     */
    public void myselfExists(SubQuery<GiantCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        GiantCB cb = new GiantCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(GiantCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected GiantCB newMyCB() {
        return new GiantCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return GiantCQ.class.getName(); }
