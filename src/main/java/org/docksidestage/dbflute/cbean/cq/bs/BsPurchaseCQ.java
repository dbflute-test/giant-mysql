...
public class BsPurchaseCQ extends AbstractBsPurchaseCQ {
    ...
    public Map<String, GiantCQ> xdfgetPurchaseId_ExistsReferrer_GiantList() { return xgetSQueMap("purchaseId_ExistsReferrer_GiantList"); }
    public String keepPurchaseId_ExistsReferrer_GiantList(GiantCQ sq) { return xkeepSQue("purchaseId_ExistsReferrer_GiantList", sq); }

    public Map<String, GiantRefCQ> xdfgetPurchaseId_ExistsReferrer_GiantRefList() { return xgetSQueMap("purchaseId_ExistsReferrer_GiantRefList"); }
    public String keepPurchaseId_ExistsReferrer_GiantRefList(GiantRefCQ sq) { return xkeepSQue("purchaseId_ExistsReferrer_GiantRefList", sq); }

    public Map<String, GiantSideCQ> xdfgetPurchaseId_ExistsReferrer_GiantSideList() { return xgetSQueMap("purchaseId_ExistsReferrer_GiantSideList"); }
    public String keepPurchaseId_ExistsReferrer_GiantSideList(GiantSideCQ sq) { return xkeepSQue("purchaseId_ExistsReferrer_GiantSideList", sq); }
    ...
    public Map<String, GiantCQ> xdfgetPurchaseId_NotExistsReferrer_GiantList() { return xgetSQueMap("purchaseId_NotExistsReferrer_GiantList"); }
    public String keepPurchaseId_NotExistsReferrer_GiantList(GiantCQ sq) { return xkeepSQue("purchaseId_NotExistsReferrer_GiantList", sq); }

    public Map<String, GiantRefCQ> xdfgetPurchaseId_NotExistsReferrer_GiantRefList() { return xgetSQueMap("purchaseId_NotExistsReferrer_GiantRefList"); }
    public String keepPurchaseId_NotExistsReferrer_GiantRefList(GiantRefCQ sq) { return xkeepSQue("purchaseId_NotExistsReferrer_GiantRefList", sq); }

    public Map<String, GiantSideCQ> xdfgetPurchaseId_NotExistsReferrer_GiantSideList() { return xgetSQueMap("purchaseId_NotExistsReferrer_GiantSideList"); }
    public String keepPurchaseId_NotExistsReferrer_GiantSideList(GiantSideCQ sq) { return xkeepSQue("purchaseId_NotExistsReferrer_GiantSideList", sq); }
    ...
    public Map<String, GiantCQ> xdfgetPurchaseId_SpecifyDerivedReferrer_GiantList() { return xgetSQueMap("purchaseId_SpecifyDerivedReferrer_GiantList"); }
    public String keepPurchaseId_SpecifyDerivedReferrer_GiantList(GiantCQ sq) { return xkeepSQue("purchaseId_SpecifyDerivedReferrer_GiantList", sq); }

    public Map<String, GiantRefCQ> xdfgetPurchaseId_SpecifyDerivedReferrer_GiantRefList() { return xgetSQueMap("purchaseId_SpecifyDerivedReferrer_GiantRefList"); }
    public String keepPurchaseId_SpecifyDerivedReferrer_GiantRefList(GiantRefCQ sq) { return xkeepSQue("purchaseId_SpecifyDerivedReferrer_GiantRefList", sq); }

    public Map<String, GiantSideCQ> xdfgetPurchaseId_SpecifyDerivedReferrer_GiantSideList() { return xgetSQueMap("purchaseId_SpecifyDerivedReferrer_GiantSideList"); }
    public String keepPurchaseId_SpecifyDerivedReferrer_GiantSideList(GiantSideCQ sq) { return xkeepSQue("purchaseId_SpecifyDerivedReferrer_GiantSideList", sq); }
    ...
    public Map<String, GiantCQ> xdfgetPurchaseId_QueryDerivedReferrer_GiantList() { return xgetSQueMap("purchaseId_QueryDerivedReferrer_GiantList"); }
    public String keepPurchaseId_QueryDerivedReferrer_GiantList(GiantCQ sq) { return xkeepSQue("purchaseId_QueryDerivedReferrer_GiantList", sq); }
    public Map<String, Object> xdfgetPurchaseId_QueryDerivedReferrer_GiantListParameter() { return xgetSQuePmMap("purchaseId_QueryDerivedReferrer_GiantList"); }
    public String keepPurchaseId_QueryDerivedReferrer_GiantListParameter(Object pm) { return xkeepSQuePm("purchaseId_QueryDerivedReferrer_GiantList", pm); }

    public Map<String, GiantRefCQ> xdfgetPurchaseId_QueryDerivedReferrer_GiantRefList() { return xgetSQueMap("purchaseId_QueryDerivedReferrer_GiantRefList"); }
    public String keepPurchaseId_QueryDerivedReferrer_GiantRefList(GiantRefCQ sq) { return xkeepSQue("purchaseId_QueryDerivedReferrer_GiantRefList", sq); }
    public Map<String, Object> xdfgetPurchaseId_QueryDerivedReferrer_GiantRefListParameter() { return xgetSQuePmMap("purchaseId_QueryDerivedReferrer_GiantRefList"); }
    public String keepPurchaseId_QueryDerivedReferrer_GiantRefListParameter(Object pm) { return xkeepSQuePm("purchaseId_QueryDerivedReferrer_GiantRefList", pm); }

    public Map<String, GiantSideCQ> xdfgetPurchaseId_QueryDerivedReferrer_GiantSideList() { return xgetSQueMap("purchaseId_QueryDerivedReferrer_GiantSideList"); }
    public String keepPurchaseId_QueryDerivedReferrer_GiantSideList(GiantSideCQ sq) { return xkeepSQue("purchaseId_QueryDerivedReferrer_GiantSideList", sq); }
    public Map<String, Object> xdfgetPurchaseId_QueryDerivedReferrer_GiantSideListParameter() { return xgetSQuePmMap("purchaseId_QueryDerivedReferrer_GiantSideList"); }
    public String keepPurchaseId_QueryDerivedReferrer_GiantSideListParameter(Object pm) { return xkeepSQuePm("purchaseId_QueryDerivedReferrer_GiantSideList", pm); }
