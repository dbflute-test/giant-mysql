...
/**
 * The condition-query for in-line of giant_side.
 * @author DBFlute(AutoGenerator)
 */
public class GiantSideCIQ extends AbstractBsGiantSideCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsGiantSideCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public GiantSideCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsGiantSideCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueGiantSideId() { return _myCQ.xdfgetGiantSideId(); }
    public String keepGiantSideId_ExistsReferrer_GiantSideSelfList(GiantSideCQ sq)
    { throwIICBOE("ExistsReferrer"); return null; }
    public String keepGiantSideId_NotExistsReferrer_GiantSideSelfList(GiantSideCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepGiantSideId_SpecifyDerivedReferrer_GiantSideSelfList(GiantSideCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    public String keepGiantSideId_QueryDerivedReferrer_GiantSideSelfList(GiantSideCQ sq)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepGiantSideId_QueryDerivedReferrer_GiantSideSelfListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    ...
    public String keepScalarCondition(GiantSideCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(GiantSideCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(GiantSideCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(GiantSideCQ sq)
    ...
    protected String xinCB() { return GiantSideCB.class.getName(); }
    protected String xinCQ() { return GiantSideCQ.class.getName(); }
}
