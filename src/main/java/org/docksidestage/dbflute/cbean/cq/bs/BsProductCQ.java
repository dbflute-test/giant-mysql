...
public class BsProductCQ extends AbstractBsProductCQ {
    ...
    public Map<String, GiantCQ> xdfgetProductId_ExistsReferrer_GiantList() { return xgetSQueMap("productId_ExistsReferrer_GiantList"); }
    public String keepProductId_ExistsReferrer_GiantList(GiantCQ sq) { return xkeepSQue("productId_ExistsReferrer_GiantList", sq); }

    public Map<String, GiantRefCQ> xdfgetProductId_ExistsReferrer_GiantRefList() { return xgetSQueMap("productId_ExistsReferrer_GiantRefList"); }
    public String keepProductId_ExistsReferrer_GiantRefList(GiantRefCQ sq) { return xkeepSQue("productId_ExistsReferrer_GiantRefList", sq); }

    public Map<String, GiantSideCQ> xdfgetProductId_ExistsReferrer_GiantSideList() { return xgetSQueMap("productId_ExistsReferrer_GiantSideList"); }
    public String keepProductId_ExistsReferrer_GiantSideList(GiantSideCQ sq) { return xkeepSQue("productId_ExistsReferrer_GiantSideList", sq); }
    ...
    public Map<String, GiantCQ> xdfgetProductId_NotExistsReferrer_GiantList() { return xgetSQueMap("productId_NotExistsReferrer_GiantList"); }
    public String keepProductId_NotExistsReferrer_GiantList(GiantCQ sq) { return xkeepSQue("productId_NotExistsReferrer_GiantList", sq); }

    public Map<String, GiantRefCQ> xdfgetProductId_NotExistsReferrer_GiantRefList() { return xgetSQueMap("productId_NotExistsReferrer_GiantRefList"); }
    public String keepProductId_NotExistsReferrer_GiantRefList(GiantRefCQ sq) { return xkeepSQue("productId_NotExistsReferrer_GiantRefList", sq); }

    public Map<String, GiantSideCQ> xdfgetProductId_NotExistsReferrer_GiantSideList() { return xgetSQueMap("productId_NotExistsReferrer_GiantSideList"); }
    public String keepProductId_NotExistsReferrer_GiantSideList(GiantSideCQ sq) { return xkeepSQue("productId_NotExistsReferrer_GiantSideList", sq); }
    ...
    public Map<String, GiantCQ> xdfgetProductId_SpecifyDerivedReferrer_GiantList() { return xgetSQueMap("productId_SpecifyDerivedReferrer_GiantList"); }
    public String keepProductId_SpecifyDerivedReferrer_GiantList(GiantCQ sq) { return xkeepSQue("productId_SpecifyDerivedReferrer_GiantList", sq); }

    public Map<String, GiantRefCQ> xdfgetProductId_SpecifyDerivedReferrer_GiantRefList() { return xgetSQueMap("productId_SpecifyDerivedReferrer_GiantRefList"); }
    public String keepProductId_SpecifyDerivedReferrer_GiantRefList(GiantRefCQ sq) { return xkeepSQue("productId_SpecifyDerivedReferrer_GiantRefList", sq); }

    public Map<String, GiantSideCQ> xdfgetProductId_SpecifyDerivedReferrer_GiantSideList() { return xgetSQueMap("productId_SpecifyDerivedReferrer_GiantSideList"); }
    public String keepProductId_SpecifyDerivedReferrer_GiantSideList(GiantSideCQ sq) { return xkeepSQue("productId_SpecifyDerivedReferrer_GiantSideList", sq); }
    ...
    public Map<String, GiantCQ> xdfgetProductId_QueryDerivedReferrer_GiantList() { return xgetSQueMap("productId_QueryDerivedReferrer_GiantList"); }
    public String keepProductId_QueryDerivedReferrer_GiantList(GiantCQ sq) { return xkeepSQue("productId_QueryDerivedReferrer_GiantList", sq); }
    public Map<String, Object> xdfgetProductId_QueryDerivedReferrer_GiantListParameter() { return xgetSQuePmMap("productId_QueryDerivedReferrer_GiantList"); }
    public String keepProductId_QueryDerivedReferrer_GiantListParameter(Object pm) { return xkeepSQuePm("productId_QueryDerivedReferrer_GiantList", pm); }

    public Map<String, GiantRefCQ> xdfgetProductId_QueryDerivedReferrer_GiantRefList() { return xgetSQueMap("productId_QueryDerivedReferrer_GiantRefList"); }
    public String keepProductId_QueryDerivedReferrer_GiantRefList(GiantRefCQ sq) { return xkeepSQue("productId_QueryDerivedReferrer_GiantRefList", sq); }
    public Map<String, Object> xdfgetProductId_QueryDerivedReferrer_GiantRefListParameter() { return xgetSQuePmMap("productId_QueryDerivedReferrer_GiantRefList"); }
    public String keepProductId_QueryDerivedReferrer_GiantRefListParameter(Object pm) { return xkeepSQuePm("productId_QueryDerivedReferrer_GiantRefList", pm); }

    public Map<String, GiantSideCQ> xdfgetProductId_QueryDerivedReferrer_GiantSideList() { return xgetSQueMap("productId_QueryDerivedReferrer_GiantSideList"); }
    public String keepProductId_QueryDerivedReferrer_GiantSideList(GiantSideCQ sq) { return xkeepSQue("productId_QueryDerivedReferrer_GiantSideList", sq); }
    public Map<String, Object> xdfgetProductId_QueryDerivedReferrer_GiantSideListParameter() { return xgetSQuePmMap("productId_QueryDerivedReferrer_GiantSideList"); }
    public String keepProductId_QueryDerivedReferrer_GiantSideListParameter(Object pm) { return xkeepSQuePm("productId_QueryDerivedReferrer_GiantSideList", pm); }
