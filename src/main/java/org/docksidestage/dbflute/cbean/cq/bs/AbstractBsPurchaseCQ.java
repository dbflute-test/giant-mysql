...
public abstract class AbstractBsPurchaseCQ extends AbstractConditionQuery {
     ...
     * {exists (select ZONE_PURCHASE_ID from giant where ...)} <br>
     * (Giant as base point)giant by ZONE_PURCHASE_ID, named 'giantAsOne'.
     * <pre>
    ...
    public void existsGiant(SubQuery<GiantCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepPurchaseId_ExistsReferrer_GiantList(cb.query());
        registerExistsReferrer(cb.query(), "PURCHASE_ID", "ZONE_PURCHASE_ID", pp, "giantList");
    }
    public abstract String keepPurchaseId_ExistsReferrer_GiantList(GiantCQ sq);

    /**
     * Set up ExistsReferrer (correlated sub-query). <br>
     * {exists (select ZONE_PURCHASE_ID from giant_ref where ...)} <br>
     * (Referrer of Giant)giant_ref by ZONE_PURCHASE_ID, named 'giantRefAsOne'.
     * <pre>
    ...
    public void existsGiantRef(SubQuery<GiantRefCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepPurchaseId_ExistsReferrer_GiantRefList(cb.query());
        registerExistsReferrer(cb.query(), "PURCHASE_ID", "ZONE_PURCHASE_ID", pp, "giantRefList");
    }
    public abstract String keepPurchaseId_ExistsReferrer_GiantRefList(GiantRefCQ sq);

    /**
     * Set up ExistsReferrer (correlated sub-query). <br>
     * {exists (select ZONE_PURCHASE_ID from giant_side where ...)} <br>
     * (simple Side of Giant)giant_side by ZONE_PURCHASE_ID, named 'giantSideAsOne'.
     * <pre>
    ...
    public void existsGiantSide(SubQuery<GiantSideCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepPurchaseId_ExistsReferrer_GiantSideList(cb.query());
        registerExistsReferrer(cb.query(), "PURCHASE_ID", "ZONE_PURCHASE_ID", pp, "giantSideList");
    }
    public abstract String keepPurchaseId_ExistsReferrer_GiantSideList(GiantSideCQ sq);
     ...
     * {not exists (select ZONE_PURCHASE_ID from giant where ...)} <br>
     * (Giant as base point)giant by ZONE_PURCHASE_ID, named 'giantAsOne'.
     * <pre>
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of PurchaseId_NotExistsReferrer_GiantList for 'not exists'. (NotNull)
     */
    public void notExistsGiant(SubQuery<GiantCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        GiantCB cb = new GiantCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepPurchaseId_NotExistsReferrer_GiantList(cb.query());
        registerNotExistsReferrer(cb.query(), "PURCHASE_ID", "ZONE_PURCHASE_ID", pp, "giantList");
    }
    public abstract String keepPurchaseId_NotExistsReferrer_GiantList(GiantCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select ZONE_PURCHASE_ID from giant_ref where ...)} <br>
     * (Referrer of Giant)giant_ref by ZONE_PURCHASE_ID, named 'giantRefAsOne'.
     * <pre>
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of PurchaseId_NotExistsReferrer_GiantRefList for 'not exists'. (NotNull)
     */
    public void notExistsGiantRef(SubQuery<GiantRefCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        GiantRefCB cb = new GiantRefCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepPurchaseId_NotExistsReferrer_GiantRefList(cb.query());
        registerNotExistsReferrer(cb.query(), "PURCHASE_ID", "ZONE_PURCHASE_ID", pp, "giantRefList");
    }
    public abstract String keepPurchaseId_NotExistsReferrer_GiantRefList(GiantRefCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select ZONE_PURCHASE_ID from giant_side where ...)} <br>
     * (simple Side of Giant)giant_side by ZONE_PURCHASE_ID, named 'giantSideAsOne'.
     * <pre>
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of PurchaseId_NotExistsReferrer_GiantSideList for 'not exists'. (NotNull)
     */
    public void notExistsGiantSide(SubQuery<GiantSideCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        GiantSideCB cb = new GiantSideCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepPurchaseId_NotExistsReferrer_GiantSideList(cb.query());
        registerNotExistsReferrer(cb.query(), "PURCHASE_ID", "ZONE_PURCHASE_ID", pp, "giantSideList");
    }
    public abstract String keepPurchaseId_NotExistsReferrer_GiantSideList(GiantSideCQ sq);
    ...
    public void xsderiveGiantList(String fn, SubQuery<GiantCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepPurchaseId_SpecifyDerivedReferrer_GiantList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "PURCHASE_ID", "ZONE_PURCHASE_ID", pp, "giantList", al, op);
    }
    public abstract String keepPurchaseId_SpecifyDerivedReferrer_GiantList(GiantCQ sq);
    ...
    public void xsderiveGiantRefList(String fn, SubQuery<GiantRefCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepPurchaseId_SpecifyDerivedReferrer_GiantRefList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "PURCHASE_ID", "ZONE_PURCHASE_ID", pp, "giantRefList", al, op);
    }
    public abstract String keepPurchaseId_SpecifyDerivedReferrer_GiantRefList(GiantRefCQ sq);
    ...
    public void xsderiveGiantSideList(String fn, SubQuery<GiantSideCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepPurchaseId_SpecifyDerivedReferrer_GiantSideList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "PURCHASE_ID", "ZONE_PURCHASE_ID", pp, "giantSideList", al, op);
    }
    public abstract String keepPurchaseId_SpecifyDerivedReferrer_GiantSideList(GiantSideCQ sq);
    ...
    public void xqderiveGiantList(String fn, SubQuery<GiantCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        GiantCB cb = new GiantCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepPurchaseId_QueryDerivedReferrer_GiantList(cb.query()); String prpp = keepPurchaseId_QueryDerivedReferrer_GiantListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "PURCHASE_ID", "ZONE_PURCHASE_ID", sqpp, "giantList", rd, vl, prpp, op);
    }
    public abstract String keepPurchaseId_QueryDerivedReferrer_GiantList(GiantCQ sq);
    public abstract String keepPurchaseId_QueryDerivedReferrer_GiantListParameter(Object vl);
    ...
    public void xqderiveGiantRefList(String fn, SubQuery<GiantRefCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        GiantRefCB cb = new GiantRefCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepPurchaseId_QueryDerivedReferrer_GiantRefList(cb.query()); String prpp = keepPurchaseId_QueryDerivedReferrer_GiantRefListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "PURCHASE_ID", "ZONE_PURCHASE_ID", sqpp, "giantRefList", rd, vl, prpp, op);
    }
    public abstract String keepPurchaseId_QueryDerivedReferrer_GiantRefList(GiantRefCQ sq);
    public abstract String keepPurchaseId_QueryDerivedReferrer_GiantRefListParameter(Object vl);
    ...
    public void xqderiveGiantSideList(String fn, SubQuery<GiantSideCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        GiantSideCB cb = new GiantSideCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepPurchaseId_QueryDerivedReferrer_GiantSideList(cb.query()); String prpp = keepPurchaseId_QueryDerivedReferrer_GiantSideListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "PURCHASE_ID", "ZONE_PURCHASE_ID", sqpp, "giantSideList", rd, vl, prpp, op);
    }
    public abstract String keepPurchaseId_QueryDerivedReferrer_GiantSideList(GiantSideCQ sq);
    public abstract String keepPurchaseId_QueryDerivedReferrer_GiantSideListParameter(Object vl);
