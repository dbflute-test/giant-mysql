...
/**
 * The condition-query for in-line of giant_ref.
 * @author DBFlute(AutoGenerator)
 */
public class GiantRefCIQ extends AbstractBsGiantRefCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsGiantRefCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public GiantRefCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsGiantRefCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueGiantRefId() { return _myCQ.xdfgetGiantRefId(); }
    public String keepGiantRefId_ExistsReferrer_GiantRefSelfList(GiantRefCQ sq)
    { throwIICBOE("ExistsReferrer"); return null; }
    public String keepGiantRefId_NotExistsReferrer_GiantRefSelfList(GiantRefCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepGiantRefId_SpecifyDerivedReferrer_GiantRefSelfList(GiantRefCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    public String keepGiantRefId_QueryDerivedReferrer_GiantRefSelfList(GiantRefCQ sq)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepGiantRefId_QueryDerivedReferrer_GiantRefSelfListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    ...
    public String keepScalarCondition(GiantRefCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(GiantRefCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(GiantRefCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(GiantRefCQ sq)
    ...
    protected String xinCB() { return GiantRefCB.class.getName(); }
    protected String xinCQ() { return GiantRefCQ.class.getName(); }
}
