...
/**
 * The base condition-bean of giant.
 * @author DBFlute(AutoGenerator)
 */
public class BsGiantCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected GiantCQ _conditionQuery;
     ...
     * @return this. (NotNull)
     */
    public GiantCB acceptPK(Long giantId) {
     ...
     * @return this. (NotNull)
     */
    public GiantCB acceptUniqueOfUnique1stIntegerUnique2ndIntegerUnique3rdIntegerUnique4thInteger(Integer unique1stInteger, Integer unique2ndInteger, Integer unique3rdInteger, Integer unique4thInteger) {
     ...
     * @return this. (NotNull)
     */
    public GiantCB acceptUniqueOfUniqueInteger(Integer uniqueInteger) {
     ...
     * @return this. (NotNull)
     */
    public GiantCB acceptUniqueOfUniqueString(String uniqueString) {
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_GiantId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_GiantId_Desc();
        return this;
    }
     ...
     */
    public GiantCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public GiantCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected GiantCQ doGetConditionQuery() {
    ...
    protected GiantCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected GiantCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        GiantCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected GiantCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new GiantCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<GiantCB> unionCBLambda) {
        final GiantCB cb = new GiantCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final GiantCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<GiantCB> unionCBLambda) {
        final GiantCB cb = new GiantCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final GiantCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">giantBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">giant</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">giant</span>.<span style="color: #CC4747">getGiantStatus()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
    ...
    protected GiantNss _nssGiantSelf;
    public GiantNss xdfgetNssGiantSelf() {
        if (_nssGiantSelf == null) { _nssGiantSelf = new GiantNss(null); }
        return _nssGiantSelf;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">giantBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_GiantSelf()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">giant</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">giant</span>.<span style="color: #CC4747">getGiantSelf()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public GiantNss setupSelect_GiantSelf() {
        assertSetupSelectPurpose("giantSelf");
        if (hasSpecifiedLocalColumn()) {
            specify().columnSelfParentId();
        }
        doSetupSelect(() -> query().queryGiantSelf());
        if (_nssGiantSelf == null || !_nssGiantSelf.hasConditionQuery())
        { _nssGiantSelf = new GiantNss(query().queryGiantSelf()); }
        return _nssGiantSelf;
    }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">giant</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">giant</span>.<span style="color: #CC4747">getMember()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">giant</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">giant</span>.<span style="color: #CC4747">getProduct()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">giant</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">giant</span>.<span style="color: #CC4747">getPurchase()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    protected GiantSideNss _nssGiantSideAsOne;
    public GiantSideNss xdfgetNssGiantSideAsOne() {
        if (_nssGiantSideAsOne == null) { _nssGiantSideAsOne = new GiantSideNss(null); }
        return _nssGiantSideAsOne;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">giantBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_GiantSideAsOne()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">giant</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">giant</span>.<span style="color: #CC4747">getGiantSideAsOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public GiantSideNss setupSelect_GiantSideAsOne() {
        assertSetupSelectPurpose("giantSideAsOne");
        doSetupSelect(() -> query().queryGiantSideAsOne());
        if (_nssGiantSideAsOne == null || !_nssGiantSideAsOne.hasConditionQuery())
        { _nssGiantSideAsOne = new GiantSideNss(query().queryGiantSideAsOne()); }
        return _nssGiantSideAsOne;
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<GiantCQ> {
        protected GiantStatusCB.HpSpecification _giantStatus;
        protected GiantCB.HpSpecification _giantSelf;
        ...
        protected GiantSideCB.HpSpecification _giantSideAsOne;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<GiantCQ> qyCall
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryGiantSelf()
        ...
        @Override
        protected String getTableDbName() { return "giant"; }
        /**
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public GiantCB.HpSpecification specifyGiantSelf() {
            assertRelation("giantSelf");
            if (_giantSelf == null) {
                _giantSelf = new GiantCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryGiantSelf()
                                    , () -> _qyCall.qy().queryGiantSelf())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _giantSelf.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryGiantSelf()
                      , () -> xsyncQyCall().qy().queryGiantSelf()));
                }
            }
            return _giantSelf;
        }
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public GiantSideCB.HpSpecification specifyGiantSideAsOne() {
            assertRelation("giantSideAsOne");
            if (_giantSideAsOne == null) {
                _giantSideAsOne = new GiantSideCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryGiantSideAsOne()
                                    , () -> _qyCall.qy().queryGiantSideAsOne())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _giantSideAsOne.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryGiantSideAsOne()
                      , () -> xsyncQyCall().qy().queryGiantSideAsOne()));
                }
            }
         ...
         * {select max(FOO) from giant where ...) as FOO_MAX} <br>
         * (Giant as base point)GIANT by SELF_PARENT_ID, named 'giantSelfList'.
         * <pre>
         * cb.specify().<span style="color: #CC4747">derived${relationMethodIdentityName}()</span>.<span style="color: #CC4747">max</span>(giantCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
         *     giantCB.specify().<span style="color: #CC4747">column...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *     giantCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, Giant.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<GiantCB, GiantCQ> derivedGiantSelf() {
            assertDerived("giantSelfList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<GiantCB> sq, GiantCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveGiantSelfList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from giant_ref where ...) as FOO_MAX} <br>
         ...
         * }, GiantRef.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<GiantRefCB, GiantCQ> derivedGiantRef() {
            assertDerived("giantRefList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<GiantRefCB> sq, GiantCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveGiantRefList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<GiantCB, GiantCQ> myselfDerived() {
     ...
     */
    public GiantCB dreamCruiseCB() {
        GiantCB cb = new GiantCB();
        cb.xsetupForDreamCruise((GiantCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<GiantCB> columnQuery(final SpecifyQuery<GiantCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected GiantCB xcreateColumnQueryCB() {
        GiantCB cb = new GiantCB();
        cb.xsetupForColumnQuery((GiantCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<GiantCB> orCBLambda) {
        xorSQ((GiantCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<GiantCB> andCBLambda) {
        xorSQAP((GiantCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return GiantCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return GiantCQ.class.getName(); }
