...
public class BsProductCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<ProductCQ> {
         ...
         */
        public HpSDRFunction<GiantCB, ProductCQ> derivedGiant() {
            assertDerived("giantList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<GiantCB> sq, ProductCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<GiantRefCB, ProductCQ> derivedGiantRef() {
            assertDerived("giantRefList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<GiantRefCB> sq, ProductCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<GiantSideCB, ProductCQ> derivedGiantSide() {
            assertDerived("giantSideList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<GiantSideCB> sq, ProductCQ cq, String al, DerivedReferrerOption op)
