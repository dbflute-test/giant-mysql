...
public class BsPurchaseCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<PurchaseCQ> {
         ...
         */
        public HpSDRFunction<GiantCB, PurchaseCQ> derivedGiant() {
            assertDerived("giantList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<GiantCB> sq, PurchaseCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<GiantRefCB, PurchaseCQ> derivedGiantRef() {
            assertDerived("giantRefList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<GiantRefCB> sq, PurchaseCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<GiantSideCB, PurchaseCQ> derivedGiantSide() {
            assertDerived("giantSideList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<GiantSideCB> sq, PurchaseCQ cq, String al, DerivedReferrerOption op)
