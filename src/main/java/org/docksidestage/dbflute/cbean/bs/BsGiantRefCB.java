...
/**
 * The base condition-bean of giant_ref.
 * @author DBFlute(AutoGenerator)
 */
public class BsGiantRefCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected GiantRefCQ _conditionQuery;
     ...
     * @return this. (NotNull)
     */
    public GiantRefCB acceptPK(Long giantRefId) {
        assertObjectNotNull("giantRefId", giantRefId);
        BsGiantRefCB cb = this;
        cb.query().setGiantRefId_Equal(giantRefId);
        return (GiantRefCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public GiantRefCB acceptUniqueOfUnique1stIntegerUnique2ndIntegerUnique3rdIntegerUnique4thInteger(Integer unique1stInteger, Integer unique2ndInteger, Integer unique3rdInteger, Integer unique4thInteger) {
     ...
     * @return this. (NotNull)
     */
    public GiantRefCB acceptUniqueOfUniqueInteger(Integer uniqueInteger) {
     ...
     * @return this. (NotNull)
     */
    public GiantRefCB acceptUniqueOfUniqueString(String uniqueString) {
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_GiantRefId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_GiantRefId_Desc();
        return this;
    }
     ...
     */
    public GiantRefCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public GiantRefCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected GiantRefCQ doGetConditionQuery() {
    ...
    protected GiantRefCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected GiantRefCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        GiantRefCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected GiantRefCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new GiantRefCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<GiantRefCB> unionCBLambda) {
        final GiantRefCB cb = new GiantRefCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final GiantRefCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<GiantRefCB> unionCBLambda) {
        final GiantRefCB cb = new GiantRefCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final GiantRefCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">giantRefBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">giantRef</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">giantRef</span>.<span style="color: #CC4747">getGiant()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">giantRef</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">giantRef</span>.<span style="color: #CC4747">getGiantStatus()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
    ...
    protected GiantRefNss _nssGiantRefSelf;
    public GiantRefNss xdfgetNssGiantRefSelf() {
        if (_nssGiantRefSelf == null) { _nssGiantRefSelf = new GiantRefNss(null); }
        return _nssGiantRefSelf;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">giantRefBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_GiantRefSelf()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">giantRef</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">giantRef</span>.<span style="color: #CC4747">getGiantRefSelf()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public GiantRefNss setupSelect_GiantRefSelf() {
        assertSetupSelectPurpose("giantRefSelf");
        if (hasSpecifiedLocalColumn()) {
            specify().columnSelfParentId();
        }
        doSetupSelect(() -> query().queryGiantRefSelf());
        if (_nssGiantRefSelf == null || !_nssGiantRefSelf.hasConditionQuery())
        { _nssGiantRefSelf = new GiantRefNss(query().queryGiantRefSelf()); }
        return _nssGiantRefSelf;
    }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">giantRef</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">giantRef</span>.<span style="color: #CC4747">getMember()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">giantRef</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">giantRef</span>.<span style="color: #CC4747">getProduct()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">giantRef</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">giantRef</span>.<span style="color: #CC4747">getPurchase()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<GiantRefCQ> {
        protected GiantCB.HpSpecification _giant;
        protected GiantStatusCB.HpSpecification _giantStatus;
        protected GiantRefCB.HpSpecification _giantRefSelf;
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<GiantRefCQ> qyCall
         ...
         */
        public SpecifiedColumn columnGiantRefId() { return doColumn("GIANT_REF_ID"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryGiantRefSelf()
                    || qyCall().qy().xgetReferrerQuery() instanceof GiantRefCQ) {
        ...
        @Override
        protected String getTableDbName() { return "giant_ref"; }
        /**
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public GiantRefCB.HpSpecification specifyGiantRefSelf() {
            assertRelation("giantRefSelf");
            if (_giantRefSelf == null) {
                _giantRefSelf = new GiantRefCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryGiantRefSelf()
                                    , () -> _qyCall.qy().queryGiantRefSelf())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _giantRefSelf.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryGiantRefSelf()
                      , () -> xsyncQyCall().qy().queryGiantRefSelf()));
                }
            }
            return _giantRefSelf;
        }
        /**
         * Prepare to specify functions about relation table. <br>
         * (会員)MEMBER by my ZONE_MEMBER_ID, named 'member'.
         ...
         */
        public HpSDRFunction<GiantRefCB, GiantRefCQ> derivedGiantRefSelf() {
            assertDerived("giantRefSelfList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<GiantRefCB> sq, GiantRefCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveGiantRefSelfList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<GiantRefCB, GiantRefCQ> myselfDerived() {
     ...
     */
    public GiantRefCB dreamCruiseCB() {
        GiantRefCB cb = new GiantRefCB();
        cb.xsetupForDreamCruise((GiantRefCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<GiantRefCB> columnQuery(final SpecifyQuery<GiantRefCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected GiantRefCB xcreateColumnQueryCB() {
        GiantRefCB cb = new GiantRefCB();
        cb.xsetupForColumnQuery((GiantRefCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<GiantRefCB> orCBLambda) {
        xorSQ((GiantRefCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<GiantRefCB> andCBLambda) {
        xorSQAP((GiantRefCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return GiantRefCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return GiantRefCQ.class.getName(); }
