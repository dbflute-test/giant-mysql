...
public abstract class BsPurchaseBhv extends AbstractBehaviorWritable<Purchase, PurchaseCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">purchaseBhv</span>.<span style="color: #CC4747">loadGiant</span>(<span style="color: #553000">purchaseList</span>, <span style="color: #553000">giantCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public NestedReferrerListGateway<Giant> loadGiant(List<Purchase> purchaseList, ReferrerConditionSetupper<GiantCB> refCBLambda) {
        xassLRArg(purchaseList, refCBLambda);
        return doLoadGiant(purchaseList, new LoadReferrerOption<GiantCB, Giant>().xinit(refCBLambda));
    }
     ...
     * (Giant as base point)GIANT by ZONE_PURCHASE_ID, named 'giantList'.
     * <pre>
     * <span style="color: #0000C0">purchaseBhv</span>.<span style="color: #CC4747">loadGiant</span>(<span style="color: #553000">purchase</span>, <span style="color: #553000">giantCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">giantCB</span>.setupSelect...
     *     <span style="color: #553000">giantCB</span>.query().set...
     *     <span style="color: #553000">giantCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">purchase</span>.<span style="color: #CC4747">getGiantList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Giant> loadGiant(Purchase purchase, ReferrerConditionSetupper<GiantCB> refCBLambda) {
        xassLRArg(purchase, refCBLambda);
        return doLoadGiant(xnewLRLs(purchase), new LoadReferrerOption<GiantCB, Giant>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Giant> doLoadGiant(List<Purchase> purchaseList, LoadReferrerOption<GiantCB, Giant> option) {
        return helpLoadReferrerInternally(purchaseList, option, "giantList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">purchaseBhv</span>.<span style="color: #CC4747">loadGiantRef</span>(<span style="color: #553000">purchaseList</span>, <span style="color: #553000">refCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<GiantRef> loadGiantRef(List<Purchase> purchaseList, ReferrerConditionSetupper<GiantRefCB> refCBLambda) {
        xassLRArg(purchaseList, refCBLambda);
        return doLoadGiantRef(purchaseList, new LoadReferrerOption<GiantRefCB, GiantRef>().xinit(refCBLambda));
    }
     ...
     * (Referrer of Giant)GIANT_REF by ZONE_PURCHASE_ID, named 'giantRefList'.
     * <pre>
     * <span style="color: #0000C0">purchaseBhv</span>.<span style="color: #CC4747">loadGiantRef</span>(<span style="color: #553000">purchase</span>, <span style="color: #553000">refCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">refCB</span>.setupSelect...
     *     <span style="color: #553000">refCB</span>.query().set...
     *     <span style="color: #553000">refCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">purchase</span>.<span style="color: #CC4747">getGiantRefList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<GiantRef> loadGiantRef(Purchase purchase, ReferrerConditionSetupper<GiantRefCB> refCBLambda) {
        xassLRArg(purchase, refCBLambda);
        return doLoadGiantRef(xnewLRLs(purchase), new LoadReferrerOption<GiantRefCB, GiantRef>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<GiantRef> doLoadGiantRef(List<Purchase> purchaseList, LoadReferrerOption<GiantRefCB, GiantRef> option) {
        return helpLoadReferrerInternally(purchaseList, option, "giantRefList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">purchaseBhv</span>.<span style="color: #CC4747">loadGiantSide</span>(<span style="color: #553000">purchaseList</span>, <span style="color: #553000">sideCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<GiantSide> loadGiantSide(List<Purchase> purchaseList, ReferrerConditionSetupper<GiantSideCB> refCBLambda) {
        xassLRArg(purchaseList, refCBLambda);
        return doLoadGiantSide(purchaseList, new LoadReferrerOption<GiantSideCB, GiantSide>().xinit(refCBLambda));
    }
     ...
     * (simple Side of Giant)GIANT_SIDE by ZONE_PURCHASE_ID, named 'giantSideList'.
     * <pre>
     * <span style="color: #0000C0">purchaseBhv</span>.<span style="color: #CC4747">loadGiantSide</span>(<span style="color: #553000">purchase</span>, <span style="color: #553000">sideCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">sideCB</span>.setupSelect...
     *     <span style="color: #553000">sideCB</span>.query().set...
     *     <span style="color: #553000">sideCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">purchase</span>.<span style="color: #CC4747">getGiantSideList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<GiantSide> loadGiantSide(Purchase purchase, ReferrerConditionSetupper<GiantSideCB> refCBLambda) {
        xassLRArg(purchase, refCBLambda);
        return doLoadGiantSide(xnewLRLs(purchase), new LoadReferrerOption<GiantSideCB, GiantSide>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<GiantSide> doLoadGiantSide(List<Purchase> purchaseList, LoadReferrerOption<GiantSideCB, GiantSide> option) {
        return helpLoadReferrerInternally(purchaseList, option, "giantSideList");
    }
