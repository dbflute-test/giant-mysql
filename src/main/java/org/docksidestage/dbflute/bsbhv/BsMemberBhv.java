 ...
 *
 * [referrer table]
 *     GIANT, GIANT_REF, GIANT_SIDE, MEMBER_ADDRESS, MEMBER_FOLLOWING, MEMBER_LOGIN, PURCHASE, MEMBER_SECURITY, MEMBER_SERVICE, MEMBER_WITHDRAWAL
 *
 * [foreign property]
 *     memberStatus, memberAddressAsValid, memberLoginAsLatest, memberSecurityAsOne, memberServiceAsOne, memberWithdrawalAsOne
 *
 * [referrer property]
 *     giantList, giantRefList, giantSideList, memberAddressList, memberFollowingByMyMemberIdList, memberFollowingByYourMemberIdList, memberLoginList, purchaseList
 * </pre>
...
public abstract class BsMemberBhv extends AbstractBehaviorWritable<Member, MemberCB> {
     ...
     * (Giant as base point)GIANT by ZONE_MEMBER_ID, named 'giantList'.
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadGiant</span>(<span style="color: #553000">memberList</span>, <span style="color: #553000">giantCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (Member member : <span style="color: #553000">memberList</span>) {
     *     ... = member.<span style="color: #CC4747">getGiantList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     * cb.query().setZoneMemberId_InScope(pkList);
     * cb.query().addOrderBy_ZoneMemberId_Asc();
     * </pre>
     * @param memberList The entity list of member. (NotNull)
     * @param refCBLambda The callback to set up referrer condition-bean for loading referrer. (NotNull)
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Giant> loadGiant(List<Member> memberList, ReferrerConditionSetupper<GiantCB> refCBLambda) {
        xassLRArg(memberList, refCBLambda);
        return doLoadGiant(memberList, new LoadReferrerOption<GiantCB, Giant>().xinit(refCBLambda));
    }
     ...
     * (Giant as base point)GIANT by ZONE_MEMBER_ID, named 'giantList'.
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadGiant</span>(<span style="color: #553000">member</span>, <span style="color: #553000">giantCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">giantCB</span>.setupSelect...
     *     <span style="color: #553000">giantCB</span>.query().set...
     *     <span style="color: #553000">giantCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">member</span>.<span style="color: #CC4747">getGiantList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Giant> loadGiant(Member member, ReferrerConditionSetupper<GiantCB> refCBLambda) {
        xassLRArg(member, refCBLambda);
        return doLoadGiant(xnewLRLs(member), new LoadReferrerOption<GiantCB, Giant>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Giant> doLoadGiant(List<Member> memberList, LoadReferrerOption<GiantCB, Giant> option) {
        return helpLoadReferrerInternally(memberList, option, "giantList");
    }

    /**
     * Load referrer of giantRefList by the set-upper of referrer. <br>
     * (Referrer of Giant)GIANT_REF by ZONE_MEMBER_ID, named 'giantRefList'.
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadGiantRef</span>(<span style="color: #553000">memberList</span>, <span style="color: #553000">refCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (Member member : <span style="color: #553000">memberList</span>) {
     *     ... = member.<span style="color: #CC4747">getGiantRefList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<GiantRef> loadGiantRef(List<Member> memberList, ReferrerConditionSetupper<GiantRefCB> refCBLambda) {
        xassLRArg(memberList, refCBLambda);
        return doLoadGiantRef(memberList, new LoadReferrerOption<GiantRefCB, GiantRef>().xinit(refCBLambda));
    }
     ...
     * (Referrer of Giant)GIANT_REF by ZONE_MEMBER_ID, named 'giantRefList'.
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadGiantRef</span>(<span style="color: #553000">member</span>, <span style="color: #553000">refCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">refCB</span>.setupSelect...
     *     <span style="color: #553000">refCB</span>.query().set...
     *     <span style="color: #553000">refCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">member</span>.<span style="color: #CC4747">getGiantRefList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<GiantRef> loadGiantRef(Member member, ReferrerConditionSetupper<GiantRefCB> refCBLambda) {
        xassLRArg(member, refCBLambda);
        return doLoadGiantRef(xnewLRLs(member), new LoadReferrerOption<GiantRefCB, GiantRef>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<GiantRef> doLoadGiantRef(List<Member> memberList, LoadReferrerOption<GiantRefCB, GiantRef> option) {
        return helpLoadReferrerInternally(memberList, option, "giantRefList");
    }

    /**
     * Load referrer of giantSideList by the set-upper of referrer. <br>
     * (simple Side of Giant)GIANT_SIDE by ZONE_MEMBER_ID, named 'giantSideList'.
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadGiantSide</span>(<span style="color: #553000">memberList</span>, <span style="color: #553000">sideCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (Member member : <span style="color: #553000">memberList</span>) {
     *     ... = member.<span style="color: #CC4747">getGiantSideList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<GiantSide> loadGiantSide(List<Member> memberList, ReferrerConditionSetupper<GiantSideCB> refCBLambda) {
        xassLRArg(memberList, refCBLambda);
        return doLoadGiantSide(memberList, new LoadReferrerOption<GiantSideCB, GiantSide>().xinit(refCBLambda));
    }
     ...
     * (simple Side of Giant)GIANT_SIDE by ZONE_MEMBER_ID, named 'giantSideList'.
     * <pre>
     * <span style="color: #0000C0">memberBhv</span>.<span style="color: #CC4747">loadGiantSide</span>(<span style="color: #553000">member</span>, <span style="color: #553000">sideCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">sideCB</span>.setupSelect...
     *     <span style="color: #553000">sideCB</span>.query().set...
     *     <span style="color: #553000">sideCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">member</span>.<span style="color: #CC4747">getGiantSideList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<GiantSide> loadGiantSide(Member member, ReferrerConditionSetupper<GiantSideCB> refCBLambda) {
        xassLRArg(member, refCBLambda);
        return doLoadGiantSide(xnewLRLs(member), new LoadReferrerOption<GiantSideCB, GiantSide>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<GiantSide> doLoadGiantSide(List<Member> memberList, LoadReferrerOption<GiantSideCB, GiantSide> option) {
        return helpLoadReferrerInternally(memberList, option, "giantSideList");
    }
