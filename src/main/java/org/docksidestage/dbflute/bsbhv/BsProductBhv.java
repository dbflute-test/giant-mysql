...
public abstract class BsProductBhv extends AbstractBehaviorWritable<Product, ProductCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">loadGiant</span>(<span style="color: #553000">productList</span>, <span style="color: #553000">giantCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public NestedReferrerListGateway<Giant> loadGiant(List<Product> productList, ReferrerConditionSetupper<GiantCB> refCBLambda) {
        xassLRArg(productList, refCBLambda);
        return doLoadGiant(productList, new LoadReferrerOption<GiantCB, Giant>().xinit(refCBLambda));
    }
     ...
     * (Giant as base point)GIANT by ZONE_PRODUCT_ID, named 'giantList'.
     * <pre>
     * <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">loadGiant</span>(<span style="color: #553000">product</span>, <span style="color: #553000">giantCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">giantCB</span>.setupSelect...
     *     <span style="color: #553000">giantCB</span>.query().set...
     *     <span style="color: #553000">giantCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">product</span>.<span style="color: #CC4747">getGiantList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<Giant> loadGiant(Product product, ReferrerConditionSetupper<GiantCB> refCBLambda) {
        xassLRArg(product, refCBLambda);
        return doLoadGiant(xnewLRLs(product), new LoadReferrerOption<GiantCB, Giant>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<Giant> doLoadGiant(List<Product> productList, LoadReferrerOption<GiantCB, Giant> option) {
        return helpLoadReferrerInternally(productList, option, "giantList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">loadGiantRef</span>(<span style="color: #553000">productList</span>, <span style="color: #553000">refCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<GiantRef> loadGiantRef(List<Product> productList, ReferrerConditionSetupper<GiantRefCB> refCBLambda) {
        xassLRArg(productList, refCBLambda);
        return doLoadGiantRef(productList, new LoadReferrerOption<GiantRefCB, GiantRef>().xinit(refCBLambda));
    }
     ...
     * (Referrer of Giant)GIANT_REF by ZONE_PRODUCT_ID, named 'giantRefList'.
     * <pre>
     * <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">loadGiantRef</span>(<span style="color: #553000">product</span>, <span style="color: #553000">refCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">refCB</span>.setupSelect...
     *     <span style="color: #553000">refCB</span>.query().set...
     *     <span style="color: #553000">refCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">product</span>.<span style="color: #CC4747">getGiantRefList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<GiantRef> loadGiantRef(Product product, ReferrerConditionSetupper<GiantRefCB> refCBLambda) {
        xassLRArg(product, refCBLambda);
        return doLoadGiantRef(xnewLRLs(product), new LoadReferrerOption<GiantRefCB, GiantRef>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<GiantRef> doLoadGiantRef(List<Product> productList, LoadReferrerOption<GiantRefCB, GiantRef> option) {
        return helpLoadReferrerInternally(productList, option, "giantRefList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">loadGiantSide</span>(<span style="color: #553000">productList</span>, <span style="color: #553000">sideCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<GiantSide> loadGiantSide(List<Product> productList, ReferrerConditionSetupper<GiantSideCB> refCBLambda) {
        xassLRArg(productList, refCBLambda);
        return doLoadGiantSide(productList, new LoadReferrerOption<GiantSideCB, GiantSide>().xinit(refCBLambda));
    }
     ...
     * (simple Side of Giant)GIANT_SIDE by ZONE_PRODUCT_ID, named 'giantSideList'.
     * <pre>
     * <span style="color: #0000C0">productBhv</span>.<span style="color: #CC4747">loadGiantSide</span>(<span style="color: #553000">product</span>, <span style="color: #553000">sideCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">sideCB</span>.setupSelect...
     *     <span style="color: #553000">sideCB</span>.query().set...
     *     <span style="color: #553000">sideCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">product</span>.<span style="color: #CC4747">getGiantSideList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<GiantSide> loadGiantSide(Product product, ReferrerConditionSetupper<GiantSideCB> refCBLambda) {
        xassLRArg(product, refCBLambda);
        return doLoadGiantSide(xnewLRLs(product), new LoadReferrerOption<GiantSideCB, GiantSide>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<GiantSide> doLoadGiantSide(List<Product> productList, LoadReferrerOption<GiantSideCB, GiantSide> option) {
        return helpLoadReferrerInternally(productList, option, "giantSideList");
    }
