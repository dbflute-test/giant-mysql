...
public class Member extends BsMember {
    ...
    /** GIANT_COUNT_ALL: Derived Referrer Alias. */
    public static final String ALIAS_giantCountAll = "GIANT_COUNT_ALL";

    /** GIANT_COUNT_ALL: (Derived Referrer) */
    protected Integer _giantCountAll;
    ...
    /**
     * [get] GIANT_COUNT_ALL: (Derived Referrer)
     * @return The value of the column 'GIANT_COUNT_ALL'. (NullAllowed)
     */
    public Integer getGiantCountAll() {
        return _giantCountAll;
    }

    /**
     * [set] GIANT_COUNT_ALL: (Derived Referrer)
     * @param giantCountAll The value of the column 'GIANT_COUNT_ALL'. (NullAllowed)
     */
    public void setGiantCountAll(Integer giantCountAll) {
        _giantCountAll = giantCountAll;
    }
}
