...
/**
 * The entity of (simple Side of Giant)GIANT_SIDE as TABLE. <br>
 * one-to-one required, same record count as Giant
 * <pre>
 * [primary-key]
 *     GIANT_SIDE_ID
 *
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long giantSideId = entity.getGiantSideId();
 ...
 * entity.setGiantSideId(giantSideId);
 ...
 */
public abstract class BsGiantSide extends AbstractEntity implements DomainEntity {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_giantSideId == null) { return false; }
        return true;
    }
     ...
     */
    public void uniqueByGiantId(Long giantId) {
        __uniqueDrivenProperties.clear();
        __uniqueDrivenProperties.addPropertyName("giantId");
        setGiantId(giantId);
    }
    ...
    protected OptionalEntity<Giant> _giant;

    /**
     * [get] (Giant as base point)GIANT by my GIANT_ID, named 'giant'. <br>
     * Optional: alwaysPresent(), ifPresent().orElse(), get(), ...
     * @return The entity of foreign property 'giant'. (NotNull, EmptyAllowed: when e.g. null FK column, no setupSelect)
     */
    public OptionalEntity<Giant> getGiant() {
        if (_giant == null) { _giant = OptionalEntity.relationEmpty(this, "giant"); }
        return _giant;
    }

    /**
     * [set] (Giant as base point)GIANT by my GIANT_ID, named 'giant'.
     * @param giant The entity of foreign property 'giant'. (NullAllowed)
     */
    public void setGiant(OptionalEntity<Giant> giant) {
        _giant = giant;
    }
    ...
    protected OptionalEntity<GiantSide> _giantSideSelf;

    /**
     * [get] (simple Side of Giant)GIANT_SIDE by my SELF_PARENT_ID, named 'giantSideSelf'. <br>
     * Optional: alwaysPresent(), ifPresent().orElse(), get(), ...
     * @return The entity of foreign property 'giantSideSelf'. (NotNull, EmptyAllowed: when e.g. null FK column, no setupSelect)
     */
    public OptionalEntity<GiantSide> getGiantSideSelf() {
        if (_giantSideSelf == null) { _giantSideSelf = OptionalEntity.relationEmpty(this, "giantSideSelf"); }
        return _giantSideSelf;
    }

    /**
     * [set] (simple Side of Giant)GIANT_SIDE by my SELF_PARENT_ID, named 'giantSideSelf'.
     * @param giantSideSelf The entity of foreign property 'giantSideSelf'. (NullAllowed)
     */
    public void setGiantSideSelf(OptionalEntity<GiantSide> giantSideSelf) {
        _giantSideSelf = giantSideSelf;
    }
    ...
    protected List<GiantSide> _giantSideSelfList;

    /**
     * [get] (simple Side of Giant)GIANT_SIDE by SELF_PARENT_ID, named 'giantSideSelfList'.
     * @return The entity list of referrer property 'giantSideSelfList'. (NotNull: even if no loading, returns empty list)
     */
    public List<GiantSide> getGiantSideSelfList() {
        if (_giantSideSelfList == null) { _giantSideSelfList = newReferrerList(); }
        return _giantSideSelfList;
    }

    /**
     * [set] (simple Side of Giant)GIANT_SIDE by SELF_PARENT_ID, named 'giantSideSelfList'.
     * @param giantSideSelfList The entity list of referrer property 'giantSideSelfList'. (NullAllowed)
     */
    public void setGiantSideSelfList(List<GiantSide> giantSideSelfList) {
        _giantSideSelfList = giantSideSelfList;
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsGiantSide) {
            BsGiantSide other = (BsGiantSide)obj;
            if (!xSV(_giantSideId, other._giantSideId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_giant != null && _giant.isPresent())
        { sb.append(li).append(xbRDS(_giant, "giant")); }
        if (_giantStatus != null && _giantStatus.isPresent())
        { sb.append(li).append(xbRDS(_giantStatus, "giantStatus")); }
        if (_giantSideSelf != null && _giantSideSelf.isPresent())
        { sb.append(li).append(xbRDS(_giantSideSelf, "giantSideSelf")); }
        ...
        if (_giantSideSelfList != null) { for (GiantSide et : _giantSideSelfList)
        { if (et != null) { sb.append(li).append(xbRDS(et, "giantSideSelfList")); } } }
        return sb.toString();
    }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_giantSideId));
    ...
    protected String doBuildRelationString(String dm) {
        StringBuilder sb = new StringBuilder();
        if (_giant != null && _giant.isPresent())
        { sb.append(dm).append("giant"); }
        if (_giantStatus != null && _giantStatus.isPresent())
        { sb.append(dm).append("giantStatus"); }
        if (_giantSideSelf != null && _giantSideSelf.isPresent())
        { sb.append(dm).append("giantSideSelf"); }
        if (_member != null && _member.isPresent())
        ...
        if (_giantSideSelfList != null && !_giantSideSelfList.isEmpty())
        { sb.append(dm).append("giantSideSelfList"); }
        if (sb.length() > dm.length()) {
    ...
    @Override
    public GiantSide clone() {
        return (GiantSide)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] GIANT_SIDE_ID: {PK, NotNull, BIGINT(19)} <br>
     * @return The value of the column 'GIANT_SIDE_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getGiantSideId() {
        checkSpecifiedProperty("giantSideId");
        return _giantSideId;
    }

    /**
     * [set] GIANT_SIDE_ID: {PK, NotNull, BIGINT(19)} <br>
     * @param giantSideId The value of the column 'GIANT_SIDE_ID'. (basically NotNull if update: for the constraint)
     */
    public void setGiantSideId(Long giantSideId) {
        registerModifiedProperty("giantSideId");
        _giantSideId = giantSideId;
    }

    /**
     * [get] (Giant ID (FK))GIANT_ID: {UQ, IX+, NotNull, BIGINT(19), FK to giant} <br>
     * has compound index with INDEX_INTEGER
    ...
    /**
     * [set] (Giant ID (FK))GIANT_ID: {UQ, IX+, NotNull, BIGINT(19), FK to giant} <br>
     * has compound index with INDEX_INTEGER
    ...
    /**
     * [get] (Self Reference ID)SELF_PARENT_ID: {IX, BIGINT(19), FK to giant_side} <br>
    ...
    /**
     * [set] (Self Reference ID)SELF_PARENT_ID: {IX, BIGINT(19), FK to giant_side} <br>
     * 20% null, (10% root, 10% independent)
