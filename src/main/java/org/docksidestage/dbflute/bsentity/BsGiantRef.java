...
/**
 * The entity of (Referrer of Giant)GIANT_REF as TABLE. <br>
 * one-to-many unrequired, many many records
 * <pre>
 * [primary-key]
 *     GIANT_REF_ID
 *
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long giantRefId = entity.getGiantRefId();
 ...
 * entity.setGiantRefId(giantRefId);
 ...
 */
public abstract class BsGiantRef extends AbstractEntity implements DomainEntity {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_giantRefId == null) { return false; }
        return true;
    }
    ...
    protected OptionalEntity<GiantRef> _giantRefSelf;

    /**
     * [get] (Referrer of Giant)GIANT_REF by my SELF_PARENT_ID, named 'giantRefSelf'. <br>
     * Optional: alwaysPresent(), ifPresent().orElse(), get(), ...
     * @return The entity of foreign property 'giantRefSelf'. (NotNull, EmptyAllowed: when e.g. null FK column, no setupSelect)
     */
    public OptionalEntity<GiantRef> getGiantRefSelf() {
        if (_giantRefSelf == null) { _giantRefSelf = OptionalEntity.relationEmpty(this, "giantRefSelf"); }
        return _giantRefSelf;
    }

    /**
     * [set] (Referrer of Giant)GIANT_REF by my SELF_PARENT_ID, named 'giantRefSelf'.
     * @param giantRefSelf The entity of foreign property 'giantRefSelf'. (NullAllowed)
     */
    public void setGiantRefSelf(OptionalEntity<GiantRef> giantRefSelf) {
        _giantRefSelf = giantRefSelf;
    }
    ...
    protected List<GiantRef> _giantRefSelfList;

    /**
     * [get] (Referrer of Giant)GIANT_REF by SELF_PARENT_ID, named 'giantRefSelfList'.
     * @return The entity list of referrer property 'giantRefSelfList'. (NotNull: even if no loading, returns empty list)
     */
    public List<GiantRef> getGiantRefSelfList() {
        if (_giantRefSelfList == null) { _giantRefSelfList = newReferrerList(); }
        return _giantRefSelfList;
    }

    /**
     * [set] (Referrer of Giant)GIANT_REF by SELF_PARENT_ID, named 'giantRefSelfList'.
     * @param giantRefSelfList The entity list of referrer property 'giantRefSelfList'. (NullAllowed)
     */
    public void setGiantRefSelfList(List<GiantRef> giantRefSelfList) {
        _giantRefSelfList = giantRefSelfList;
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsGiantRef) {
            BsGiantRef other = (BsGiantRef)obj;
            if (!xSV(_giantRefId, other._giantRefId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_giantRefSelf != null && _giantRefSelf.isPresent())
        { sb.append(li).append(xbRDS(_giantRefSelf, "giantRefSelf")); }
        ...
        if (_giantRefSelfList != null) { for (GiantRef et : _giantRefSelfList)
        { if (et != null) { sb.append(li).append(xbRDS(et, "giantRefSelfList")); } } }
        return sb.toString();
    }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_giantRefId));
    ...
    protected String doBuildRelationString(String dm) {
        ...
        if (_giantRefSelf != null && _giantRefSelf.isPresent())
        { sb.append(dm).append("giantRefSelf"); }
        if (_member != null && _member.isPresent())
        ...
        if (_giantRefSelfList != null && !_giantRefSelfList.isEmpty())
        { sb.append(dm).append("giantRefSelfList"); }
        if (sb.length() > dm.length()) {
    ...
    @Override
    public GiantRef clone() {
        return (GiantRef)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] GIANT_REF_ID: {PK, NotNull, BIGINT(19)} <br>
     * @return The value of the column 'GIANT_REF_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getGiantRefId() {
        checkSpecifiedProperty("giantRefId");
        return _giantRefId;
    }

    /**
     * [set] GIANT_REF_ID: {PK, NotNull, BIGINT(19)} <br>
     * @param giantRefId The value of the column 'GIANT_REF_ID'. (basically NotNull if update: for the constraint)
     */
    public void setGiantRefId(Long giantRefId) {
        registerModifiedProperty("giantRefId");
        _giantRefId = giantRefId;
    }

    /**
     * [get] (Giant ID (FK))GIANT_ID: {IX+, NotNull, BIGINT(19), FK to giant} <br>
    ...
    /**
     * [set] (Giant ID (FK))GIANT_ID: {IX+, NotNull, BIGINT(19), FK to giant} <br>
     * has compound index with INDEX_INTEGER
    ...
    /**
     * [get] (Self Reference ID)SELF_PARENT_ID: {IX, BIGINT(19), FK to giant_ref} <br>
    ...
    /**
     * [set] (Self Reference ID)SELF_PARENT_ID: {IX, BIGINT(19), FK to giant_ref} <br>
     * 20% null, (10% root, 10% independent)
