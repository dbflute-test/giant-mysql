...
public class ProductDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, "商品ID", Integer.class, "productId", null, true, true, true, "INT", 10, 0, null, null, false, null, null, null, "giantList,giantRefList,giantSideList,purchaseList", null, false);
    ...
    public ReferrerInfo referrerGiantList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnProductId(), GiantDbm.getInstance().columnZoneProductId());
        return cri("FK_GIANT_ZONE_PRODUCT", "giantList", this, GiantDbm.getInstance(), mp, false, "product");
    }
    /**
    ...
    public ReferrerInfo referrerGiantRefList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnProductId(), GiantRefDbm.getInstance().columnZoneProductId());
        return cri("FK_GIANT_REF_ZONE_PRODUCT", "giantRefList", this, GiantRefDbm.getInstance(), mp, false, "product");
    }
    /**
    ...
    public ReferrerInfo referrerGiantSideList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnProductId(), GiantSideDbm.getInstance().columnZoneProductId());
        return cri("FK_GIANT_SIDE_ZONE_PRODUCT", "giantSideList", this, GiantSideDbm.getInstance(), mp, false, "product");
    }
    /**
