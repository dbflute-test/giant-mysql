...
public class MemberDbm extends AbstractDBMeta {
    ...
    public ReferrerInfo referrerGiantList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnMemberId(), GiantDbm.getInstance().columnZoneMemberId());
        return cri("FK_GIANT_ZONE_MEMBER", "giantList", this, GiantDbm.getInstance(), mp, false, "member");
    }
    /**
    ...
    public ReferrerInfo referrerGiantRefList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnMemberId(), GiantRefDbm.getInstance().columnZoneMemberId());
        return cri("FK_GIANT_REF_ZONE_MEMBER", "giantRefList", this, GiantRefDbm.getInstance(), mp, false, "member");
    }
    /**
    ...
    public ReferrerInfo referrerGiantSideList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnMemberId(), GiantSideDbm.getInstance().columnZoneMemberId());
        return cri("FK_GIANT_SIDE_ZONE_MEMBER", "giantSideList", this, GiantSideDbm.getInstance(), mp, false, "member");
    }
    /**
