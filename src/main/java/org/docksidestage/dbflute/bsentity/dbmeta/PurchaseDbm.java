...
public class PurchaseDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPurchaseId = cci("PURCHASE_ID", "PURCHASE_ID", null, "購入ID", Long.class, "purchaseId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "giantList,giantRefList,giantSideList,purchasePaymentList", null, false);
    ...
    public ReferrerInfo referrerGiantList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnPurchaseId(), GiantDbm.getInstance().columnZonePurchaseId());
        return cri("FK_GIANT_ZONE_PURCHASE", "giantList", this, GiantDbm.getInstance(), mp, false, "purchase");
    }
    /**
    ...
    public ReferrerInfo referrerGiantRefList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnPurchaseId(), GiantRefDbm.getInstance().columnZonePurchaseId());
        return cri("FK_GIANT_REF_ZONE_PURCHASE", "giantRefList", this, GiantRefDbm.getInstance(), mp, false, "purchase");
    }
    /**
    ...
    public ReferrerInfo referrerGiantSideList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnPurchaseId(), GiantSideDbm.getInstance().columnZonePurchaseId());
        return cri("FK_GIANT_SIDE_ZONE_PURCHASE", "giantSideList", this, GiantSideDbm.getInstance(), mp, false, "purchase");
    }
    /**
