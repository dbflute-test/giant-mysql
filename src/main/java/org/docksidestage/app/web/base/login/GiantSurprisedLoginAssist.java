 ...
 * @author jflute
 */
public class GiantSurprisedLoginAssist extends TypicalLoginAssist<Integer, GiantUserBean, Member> { // #change_it also UserBean
    ...
    //                                                                       =============
    @Override
    protected GiantUserBean createUserBean(Member userEntity) {
        return new GiantUserBean(userEntity);
    }

    @Override
    protected OptionalThing<String> getCookieRememberMeKey() {
        return OptionalThing.of(config.getCookieRememberMeGiantKey());
    }
    ...
    @Override
    protected void saveLoginHistory(Member member, GiantUserBean userBean, LoginSpecifiedOption option) {
    ...
    //                                                                      ==============
    @Override
    protected Class<GiantUserBean> getUserBeanType() {
        return GiantUserBean.class;
    }
