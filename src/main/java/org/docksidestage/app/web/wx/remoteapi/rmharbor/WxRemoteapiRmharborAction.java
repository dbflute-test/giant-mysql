 ...
 */
@AllowAnyoneAccess
public class WxRemoteapiRmharborAction extends GiantBaseAction {
    ...
    //                                           Lido Signin
    //                                           -----------
    // http://localhost:8151/giant/wx/remoteapi/rmharbor/lido/signin/?account=Pixy&password=sea
    // http://localhost:8151/giant/wx/remoteapi/rmharbor/lido/signin/?account=Pixy&password=land
    ...
    //                                           Lido MyPage
    //                                           -----------
    // http://localhost:8151/giant/wx/remoteapi/rmharbor/lido/mypage/
    @Execute(urlPattern = "@word/@word")
    ...
    //                                    ServerHTML Product
    //                                    ------------------
    // http://localhost:8151/giant/wx/remoteapi/rmharbor/serh/product/?productName=S
    // http://localhost:8151/giant/wx/remoteapi/rmharbor/serh/product/?productName=SeaLandPiariBonvo
    @Execute(urlPattern = "@word/@word")
    ...
    //                                     ServerHTML Signin
    //                                     -----------------
    // http://localhost:8151/giant/wx/remoteapi/rmharbor/serh/signin/?account=Pixy&password=sea
    // http://localhost:8151/giant/wx/remoteapi/rmharbor/serh/signin/?account=Pixy&password=land
    @Execute(urlPattern = "@word/@word")
