 ...
 */
@AllowAnyoneAccess
public class WxRoutingReqparamAction extends GiantBaseAction {

    private static final Logger logger = LoggerFactory.getLogger(WxRoutingReqparamAction.class);

    // [hit]
    // http://localhost:8151/giant/wx/routing/reqparam/?land=oneman
    @Execute
    ...
    // [hit]
    // http://localhost:8151/giant/wx/routing/reqparam/sea/
    // http://localhost:8151/giant/wx/routing/reqparam/?sea=mystic
    @Execute
