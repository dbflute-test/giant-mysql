 ...
 */
@AllowAnyoneAccess
public class WxAppexBasicAction extends GiantBaseAction {

    @Resource
    private MemberBhv memberBhv;

    // http://localhost:8151/giant/wx/appex/basic/
    @Execute
    public HtmlResponse index() {
        throw newApplicationException();
    }

    // http://localhost:8151/giant/wx/appex/basic/withoutinfo/
    @Execute
    ...
    // http://localhost:8151/giant/wx/appex/basic/loginfailure/
    @Execute
    public HtmlResponse loginfailure() {
        throw new LoginFailureException("sea");
    }

    // http://localhost:8151/giant/wx/appex/basic/alreadydeleted/
    @Execute
