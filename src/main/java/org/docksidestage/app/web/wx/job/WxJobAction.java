 ...
 */
@AllowAnyoneAccess
public class WxJobAction extends GiantBaseAction {
    ...
    //                                                                             Execute
    //                                                                             =======
    // http://localhost:8151/giant/wx/job/sea/hangar/mystic
    // http://localhost:8151/giant/wx/job/sea/showbase/oneman
    @Execute
    ...
    // http://localhost:8151/giant/wx/job/amba/dor
    @Execute
