 ...
 */
@AllowAnyoneAccess
public class WxRoutingMixworldSpAction extends GiantBaseAction {

    // ===================================================================================
    //                                                                             Execute
    //                                                                             =======
    // http://localhost:8151/giant/sp/wx/routing/mixworld/sea
    //   => originally: http://localhost:8151/giant/wx/routing/mixworld/sp/sea
    // http://localhost:8151/giant/sp/wx/routing/mixworld/sea/land
    //   => originally: http://localhost:8151/giant/wx/routing/mixworld/sp/sea/land
    @Execute
    ...
    // http://localhost:8151/giant/sp/wx/routing/mixworld/maihama/sea/land
    //   => originally: http://localhost:8151/giant/wx/routing/mixworld/sp/maihama/sea/land
    @Execute
