 ...
 */
@AllowAnyoneAccess
public class WxRoutingMixworldAction extends GiantBaseAction {

    // ===================================================================================
    //                                                                             Execute
    //                                                                             =======
    // http://localhost:8151/giant/wx/routing/mixworld/sea
    // http://localhost:8151/giant/wx/routing/mixworld/sea/land
    @Execute
    ...
    // http://localhost:8151/giant/wx/routing/mixworld/maihama/sea/land
    @Execute
