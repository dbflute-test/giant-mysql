 ...
 */
@AllowAnyoneAccess
public class WxRoutingNearpathBasicAction extends GiantBaseAction {

    // ===================================================================================
    //                                                                             Execute
    //                                                                             =======
    // http://localhost:8151/giant/wx/routing/nearpath/basic/sea/
    // http://localhost:8151/giant/wx/routing/nearpath/basic/string/
    // http://localhost:8151/giant/wx/routing/nearpath/basic/number/
    @Execute
    ...
    // http://localhost:8151/giant/wx/routing/nearpath/basic/string/sea
    @Execute
    public JsonResponse<RoutingCheckResult> string(String first) {
        return asJson(new RoutingCheckResult(getExecuteName(), first, "*first only"));
    }

    // http://localhost:8151/giant/wx/routing/nearpath/basic/number/1
    @Execute
