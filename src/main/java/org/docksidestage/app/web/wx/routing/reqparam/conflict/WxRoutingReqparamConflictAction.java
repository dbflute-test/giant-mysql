 ...
 */
@AllowAnyoneAccess
public class WxRoutingReqparamConflictAction extends GiantBaseAction {

    private static final Logger logger = LoggerFactory.getLogger(WxRoutingReqparamConflictAction.class);

    // [hit]
    // GET http://localhost:8151/giant/wx/routing/reqparam/conflict/?sea=mystic
    //  => OK since 1.2.3
    //  => x until 1.2.2
    @Execute
    ...
    // [hit]
    // POST http://localhost:8151/giant/wx/routing/reqparam/conflict/sea/
    @Execute
