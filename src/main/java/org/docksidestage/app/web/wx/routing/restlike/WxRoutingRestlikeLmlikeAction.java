 ...
 */
@AllowAnyoneAccess
public class WxRoutingRestlikeLmlikeAction extends GiantBaseAction {

    // ===================================================================================
    //                                                                             Execute
    //                                                                             =======
    // [hit]
    // http://localhost:8151/giant/wx/routing/restlike/lmlike/FML/
    @Execute
    ...
    // [hit]
    // http://localhost:8151/giant/wx/routing/restlike/lmlike/FML/1
    //  => http://localhost:8151/giant/wx/routing/restlike/lmlike/category/FML/1
    @Execute
    ...
    // [hit]
    // http://localhost:8151/giant/wx/routing/restlike/lmlike/1/detail
