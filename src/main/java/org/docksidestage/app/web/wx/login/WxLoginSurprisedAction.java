...
import org.docksidestage.app.web.base.login.GiantSurprisedLoginAssist;
 ...
 */
@AllowAnyoneAccess
public class WxLoginSurprisedAction extends GiantBaseAction {

    @Resource
    private GiantSurprisedLoginAssist loginAssist;
    ...
    //                                                                             Execute
    //                                                                             =======
    // http://localhost:8151/giant/wx/login/surprised/
    @Execute
    ...
    private void moreValidate(WxLoginSurprisedForm form, GiantMessages messages) {
