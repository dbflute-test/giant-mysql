 ...
 * @author jflute
 */
public class SignupAction extends GiantBaseAction {
    ...
    private void moreValidate(SignupForm form, GiantMessages messages) {
    ...
    private void sendSignupMail(SignupForm form, String token) {
        WelcomeMemberPostcard.droppedInto(postbox, postcard -> {
            postcard.setFrom(config.getMailAddressSupport(), GiantMessages.LABELS_MAIL_SUPPORT_PERSONAL);
