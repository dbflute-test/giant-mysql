...
public class ProductsAction extends GiantBaseAction {
    ...
    // /products/
    //
    // http://localhost:8151/giant/products/?productName=R
    // _/_/_/_/_/_/_/_/_/_/
    @Execute
    ...
    // /products/1
    //
    // http://localhost:8151/giant/products/1/
    // _/_/_/_/_/_/_/_/_/_/
    @Execute
    ...
    // http://localhost:8151/giant/products/sea?productName=S
    @Execute
    ...
    // http://localhost:8151/giant/products/docksideOver?productName=S
    // cannot use hyphen because of no setting in annotation
    // x http://localhost:8151/giant/products/dockside-over?productName=S
    @Execute
    ...
    // http://localhost:8151/giant/products/hangar-mystic?productName=S
    // also direct camel-case is mapped for now
    // v http://localhost:8151/giant/products/hangarMystic?productName=S
    @Execute
    ...
    // http://localhost:8151/giant/products/1/land
    @Execute
    ...
    // http://localhost:8151/giant/products/1/showbase-oneman
    // also direct camel-case is mapped for now
    // v http://localhost:8151/giant/products/1/showbaseOneman
    @Execute
