...
public class ProductsPurchasesAction extends GiantBaseAction {
    ...
    //
    // http://localhost:8151/giant/products/1/purchases/?memberName=S
    // _/_/_/_/_/_/_/_/_/_/
    @Execute
    ...
    //
    // http://localhost:8151/giant/products/1/purchases/16/
    // _/_/_/_/_/_/_/_/_/_/
    @Execute
    ...
    //                                   Test of EventSuffix
    //                                   -------------------
    // http://localhost:8151/giant/products/1/purchases/sea?memberName=S
    @Execute
    ...
    // http://localhost:8151/giant/products/1/purchases/docksideOver?memberName=S
    // cannot use hyphen because of no setting in annotation
    // x http://localhost:8151/giant/products/1/purchases/dockside-over?memberName=S
    @Execute
    ...
    // http://localhost:8151/giant/products/1/purchases/hangar-mystic?memberName=S
    // also direct camel-case is mapped for now
    // v http://localhost:8151/giant/products/1/purchases/hangarMystic?memberName=S
    @Execute
    ...
    // http://localhost:8151/giant/products/1/purchases/16/land
    @Execute
    ...
    // http://localhost:8151/giant/products/1/purchases/16/showbase-oneman
    // also direct camel-case is mapped for now
    // v http://localhost:8151/giant/products/1/purchases/16/showbaseOneman
    @Execute
