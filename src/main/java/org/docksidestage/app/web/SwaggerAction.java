 ...
 */
@AllowAnyoneAccess
public class SwaggerAction extends GiantBaseAction implements LaActionSwaggerable {
    ...
    public JsonResponse<Map<String, Object>> appjson() { // using application json
        verifySwaggerAllowed();
        Map<String, Object> swaggerMap = readResourceJson(jsonManager, "/swagger/giant_openapi3_example.json");
        return asJson(swaggerMap).switchMappingOption(op -> {}); // not to depend on application settings
    }
