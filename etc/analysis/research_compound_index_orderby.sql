...
-- ソートありで範囲条件、もうちょい絞ってみた => 速い (件数少ないから)
select count(*)
  from GIANT_REF ref
...
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
 -> Sort: ref.INDEX_DATETIME  (cost=114031 rows=106332) (actual time=2769..2780 rows=50000 loops=1)
    -> Index range scan on ref using IX_GIANT_REF_INDEX_INTEGER over (INDEX_INTEGER < 50), with index condition: (ref.INDEX_INTEGER < 50)  (cost=114031 rows=106332) (actual time=2665..2700 rows=50000 loops=1)
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
 -> Sort: ref.INDEX_DATETIME DESC  (cost=114031 rows=106332) (actual time=2718..2728 rows=50000 loops=1)
    -> Index range scan on ref using IX_GIANT_REF_INDEX_INTEGER over (INDEX_INTEGER < 50), with index condition: (ref.INDEX_INTEGER < 50)  (cost=114031 rows=106332) (actual time=2652..2694 rows=50000 loops=1)
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
